...
class DziewonskiGilbertMinioConfig:
    """
        Contains configuration for minio.
        Includes reading credentials from the environment.
    """
    ...
    def __init__(self, base_url: str, bucket: str, minio_client: Minio = None):
        ...
        Args:
            base_url: Base URL for minio. Must not contain
                'http://' as Minio adds that itself.
...
class DziewonskiGilbertLoader:
    ...
    def __init__(
        self,
        dg_root: str,
        minio_config: DziewonskiGilbertMinioConfig
    ):
        """
        Constructor
        ...
        Args:
            ...
            minio_config: MediumVelocityMinioConfig objects which has config
                info for minio.
        """

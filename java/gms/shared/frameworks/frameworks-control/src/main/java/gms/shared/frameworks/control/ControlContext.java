...
public abstract class ControlContext {
  ...
  public abstract static class Builder {
    ...
    public ControlContext build() {
      ...
      processingConfigurationConsumerUtility(
          ConfigurationConsumerUtility.builder(configRepo)
    ...
    private ConfigurationRepository getConfigRepoOrMakeDefault() {
      final Optional<ConfigurationRepository> setConfigRepo =
      ...
      if (setConfigRepo.isEmpty()) {
        configRepo =
            ClientGenerator.createClient(
                ConfigurationRepository.class, getSystemConfigOrMakeDefault());

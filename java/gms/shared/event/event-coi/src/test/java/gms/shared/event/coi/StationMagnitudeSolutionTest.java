...
class StationMagnitudeSolutionTest {
  ...
  void testSerialization(Double modelCorrection, Double stationCorrection) throws IOException {
    var expectedBuilder =
        StationMagnitudeSolution.builder()
            ...
            .setMeasurement(Optional.of(MEASUREMENT));
  ...
  void testBuildInvalidArguments(
      ...
      Optional<Double> modelCorrection,
      Optional<Double> stationCorrection,
  ...
  private static Stream<Arguments> handlerInvalidArguments() {
    return Stream.of(
        arguments(
            DoubleValue.from(-10.0, Optional.empty(), Units.MAGNITUDE),
            MODEL_CORRECTION,
            STATION_CORRECTION,
            MEASUREMENT,
            true),
        arguments(
            DoubleValue.from(51.0, Optional.empty(), Units.MAGNITUDE),
            MODEL_CORRECTION,
            STATION_CORRECTION,
            MEASUREMENT,
            true),

...
public interface StationConverter {
  ...
  /**
   * Converts a {@link SiteDao} reference station name into COI {@link Station} object this is a
   * faceted object
   *
  ...
  /**
   * Converts a list of {@link SiteDao}s and {@link SiteChanDao}s to a populated {@link Station}
   * with lists of {@link Channel} and {@link ChannelGroup} version references
   *

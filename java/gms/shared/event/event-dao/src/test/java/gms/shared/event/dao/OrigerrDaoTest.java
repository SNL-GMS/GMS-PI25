...
class OrigerrDaoTest {
  ...
  void testBuilderSadCovarianceMatrixSxx() {
    ...
    happyBuilder.withCovarianceMatrixSxx(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadCovarianceMatrixSyy() {
    ...
    happyBuilder.withCovarianceMatrixSyy(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadCovarianceMatrixSzz() {
    ...
    happyBuilder.withCovarianceMatrixSzz(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadCovarianceMatrixStt() {
    ...
    happyBuilder.withCovarianceMatrixStt(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadStandardErrorOfObservations() {
    ...
    happyBuilder.withStandardErrorOfObservations(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadSemiMajorAxisOfError() {
    ...
    happyBuilder.withSemiMajorAxisOfError(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadSemiMinorAxisOfError() {
    ...
    happyBuilder.withSemiMinorAxisOfError(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadStrikeOfSemiMajorAxis() {
    ...
    happyBuilder.withStrikeOfSemiMajorAxis(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withStrikeOfSemiMajorAxis(361);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadOriginTimeError() {
    ...
    happyBuilder.withOriginTimeError(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadConfidence() {
    ...
    happyBuilder.withConfidence(.499);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withConfidence(1.01);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }

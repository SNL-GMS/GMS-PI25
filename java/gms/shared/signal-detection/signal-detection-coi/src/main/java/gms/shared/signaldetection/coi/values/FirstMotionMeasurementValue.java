...
@AutoValue
public abstract class FirstMotionMeasurementValue
    implements EnumeratedMeasurementValue<FirstMotionType> {
  ...
  public static FirstMotionMeasurementValue fromFeatureMeasurement(
      FirstMotionType value, Optional<Double> confidence, Instant referenceTime) {
    return from(value, confidence, Optional.of(referenceTime));
  }

  public static FirstMotionMeasurementValue fromFeaturePrediction(
      FirstMotionType value, Optional<Double> confidence) {

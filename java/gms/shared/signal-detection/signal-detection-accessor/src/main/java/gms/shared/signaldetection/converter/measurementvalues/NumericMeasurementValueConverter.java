...
public final class NumericMeasurementValueConverter
  ...
  public Optional<NumericMeasurementValue> convert(
    ...
    var measuredValueExtractor =
        measurementValueSpec
            .getMeasuredValueExtractor()
            .orElseThrow(
                () -> new NoSuchElementException("Measured value extractor does not exist"));
    var units =
        measurementValueSpec
            .getUnits()
            .orElseThrow(() -> new NoSuchElementException("Units does not exist"));

    Optional<Double> uncertaintyOptional =
        measurementValueSpec
            .getUncertaintyValueExtractor()
            .map(
    ...
    return Optional.of(
        NumericMeasurementValue.from(
            Optional.empty(),
            DoubleValue.from(
                measuredValueExtractor.applyAsDouble(arrivalDao), uncertaintyOptional, units)));
  }
}

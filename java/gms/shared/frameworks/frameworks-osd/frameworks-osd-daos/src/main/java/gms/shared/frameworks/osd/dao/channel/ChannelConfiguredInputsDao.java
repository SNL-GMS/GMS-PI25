...
public class ChannelConfiguredInputsDao {
  ...
  @GeneratedValue(
      ...
      generator = "channel_configured_inputs_sequence")
  @SequenceGenerator(
      name = "channel_configured_inputs_sequence",
      sequenceName = "channel_configured_inputs_sequence",
      allocationSize = 5)
  private int id;

  @ManyToOne
  @JoinColumn(referencedColumnName = "name", name = "channel_name", nullable = false)
  private ChannelDao channel;

  @ManyToOne
  @JoinColumn(referencedColumnName = "name", name = "related_channel_name", nullable = false)
  ...
  public void setRelatedChannel(ChannelDao relatedChannel) {

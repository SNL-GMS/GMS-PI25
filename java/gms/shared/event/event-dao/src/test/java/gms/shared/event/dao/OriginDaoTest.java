...
class OriginDaoTest {
  ...
  void testBuilderSadLattitude() {
    ...
    lldKeyBuilder = new LatLonDepthTimeKey.Builder().withLatitude(-100);
    assertThrows(IllegalArgumentException.class, () -> lldKeyBuilder.build());
  ...
  void testBuilderSadLongitude() {
    ...
    lldKeyBuilder = new LatLonDepthTimeKey.Builder().withLongitude(-200);
    assertThrows(IllegalArgumentException.class, () -> lldKeyBuilder.build());
  ...
  void testBuilderSadDepth() {
    ...
    lldKeyBuilder = new LatLonDepthTimeKey.Builder().withDepth(-101);
    assertThrows(IllegalArgumentException.class, () -> lldKeyBuilder.build());

    lldKeyBuilder.withDepth(1001);
    assertThrows(IllegalArgumentException.class, () -> lldKeyBuilder.build());
  }
  ...
  void testBuilderSadTime() {
    ...
    lldKeyBuilder = new LatLonDepthTimeKey.Builder().withTime(-10000000000L);
    assertThrows(IllegalArgumentException.class, () -> lldKeyBuilder.build());
  }
  ...
  void testBuilderSadNumAssociatedArrivals() {
    ...
    happyBuilder.withNumAssociatedArrivals(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadNumTimeDefiningPhases() {
    ...
    happyBuilder.withNumTimeDefiningPhases(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadNumDepthPhases() {
    ...
    happyBuilder.withNumDepthPhases(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadGeographicRegionNumber() {
    ...
    happyBuilder.withGeographicRegionNumber(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withGeographicRegionNumber(730);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadEstimatedDepth() {
    ...
    happyBuilder.withEstimatedDepth(-1);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withEstimatedDepth(1001);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadBodyWaveMag() {
    ...
    happyBuilder.withBodyWaveMag(-10);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withBodyWaveMag(51);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadBodyWaveMagId() {
    ...
    happyBuilder.withBodyWaveMagId(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withBodyWaveMagId(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadSurfaceWaveMag() {
    ...
    happyBuilder.withSurfaceWaveMag(-10);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withSurfaceWaveMag(51);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadSurfaceWaveMagId() {
    ...
    happyBuilder.withSurfaceWaveMagId(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withSurfaceWaveMagId(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadLocalMag() {
    ...
    happyBuilder.withLocalMag(-10);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withLocalMag(51);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }

...
/**
 * A collection of correlated Signal Detection Hypothesis Dao and COI information used to help
 * completely bridge an {@link EventHypothesis} from legacy data.
 */
@AutoValue
public abstract class BridgedSdhInformation {
  ...
  public abstract static class Builder {
    public abstract Builder setSignalDetectionHypothesis(
    ...
    public BridgedSdhInformation build() {
      ...
      arInfoOpt.ifPresent(
          arInfoDao ->
              checkState(
                  sdhInfo.getAssocDao().getId().getArrivalId() == arInfoDao.getArrivalId(),
      ...
      checkState(
          sdhInfo
              ...
              .allMatch(
                  staMagDao ->
                      sdhInfo.getAssocDao().getId().getArrivalId() == staMagDao.getArrivalId()),

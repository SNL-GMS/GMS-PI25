...
public class SumStatsAccumulator<K> {
  ...
  /**
   * Constructor which takes the map used for accumulation. This form is provided so an efficient
   * map, such as an {@code EnumMap} may be passed in.
   *
   * @param map
   */
  ...
  /**
   * Returns the duration since accumulation of statistics began. This is the time since the last
   * call to {@code reset()}.
   *
   ...
   *
   * @param key
   * @return the summary statistics object, never null. If nothing has been associated with the key
   *     before, a new instance is created.
   */
  public SummaryStatistics getSummaryStatistics(final K key) {
    return statisticsMap.computeIfAbsent(key, lbl -> new SummaryStatistics());
  }
   ...
   *
   * @param key
   * @return The population variance, or {@code Double.NaN} if no values have been associated with
   *     the key.
   */
  ...
  /**
   * Returns the quadratic mean of the values that have been associated with the key. The quadratic
   * mean is the root-mean-square of the values.
   *
   * @param key
   * @return The quadratic mean , or {@code Double.NaN} if no values have been associated with the
   *     key.
   */
  ...
  /**
   * Returns the second central moment of the values that have been associated with the key. This is
   * the sum of the squared deviations from the sample mean of the values.
   *
   * @param key
   * @return The second moment, or {@code Double.NaN} if no values have been associated with the
   *     key.
   */
   ...
   *
   * @param key
   * @return The standard deviation, or {@code Double.NaN} if no values have been associated with
   *     the key.
   */
   ...
   *
   * @param key
   * @return The sum of squares, or {@code Double.NaN} if no values have been associated with the
   *     key.
   */

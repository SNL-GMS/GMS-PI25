...
logger = logging.getLogger(
    'gmsdataloader'
)  # logger name must match config-loader for log capture
...
def load_data(
    data_file_path: str,
    url: str,
    total_retries: str | None = 5
) -> None:
    """
    Loads data referenced in the filesystem and publishes it to the
    specified endpoint
    ...
    logger.info(f"Data posted to {url} successfully")

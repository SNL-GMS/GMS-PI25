...
public abstract class DetectionsWithSegmentsByStationsAndTimeRequest implements Request {
  ...
  public static DetectionsWithSegmentsByStationsAndTimeRequest create(
      ...
      @JsonProperty("excludedSignalDetections")
    ...
    Preconditions.checkState(endTime.isAfter(startTime), "EndTime must be after startTime");

    return new AutoValue_DetectionsWithSegmentsByStationsAndTimeRequest(
        stageId, stations, startTime, endTime, excludedSignalDetections);
  }
}

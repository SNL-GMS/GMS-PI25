...
export interface SemanticColors {
  ...
  dataAcqOk: string;
  dataAcqOkNotContributing: string;
  dataAcqWarning: string;
  dataAcqWarningNotContributing: string;
  dataAcqStrongWarning: string;
  dataAcqStrongWarningNotContributing: string;
  dataAcqNone: string;
}
...
export const semanticColors: SemanticColors = {
  ...
  dataAcqOkNotContributing: variables.dataAcqOkNotContributing,
  dataAcqWarning: variables.dataAcqWarning,
  dataAcqWarningNotContributing: variables.dataAcqWarningNotContributing,
  dataAcqStrongWarning: variables.dataAcqStrongWarning,
  dataAcqStrongWarningNotContributing: variables.dataAcqStrongWarningNotContributing,

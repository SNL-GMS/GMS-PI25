...
/**
 * Acceptor class that takes in a visitor and applies its corresponding visit method. This creates
 * the Acceptor/Visitor pattern for generalizing similar class methods
 *
 * @param <V> input measurement value type
 */
public interface MeasurementValueSpecAcceptor<V> {
   ...
   */
  Stream<MeasurementValueSpec<V>> accept(
      MeasurementValueSpecVisitor<V> visitor,

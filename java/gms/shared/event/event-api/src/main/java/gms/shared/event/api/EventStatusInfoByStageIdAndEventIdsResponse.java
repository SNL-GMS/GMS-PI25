...
/**
 * Defines the response body for the findEventStatusInfoByStageIdAndEventIds operations. Associates
 * a Set of {@link EventStatusInfo} objects with a {@link WorkflowDefinitionId}.
 */
@AutoValue
...
public abstract class EventStatusInfoByStageIdAndEventIdsResponse {
  ...
  /**
   * Gets the {@link ImmutableMap} linking each event {@link UUID} to its corresponding {@link
   * EventStatusInfo}
   *

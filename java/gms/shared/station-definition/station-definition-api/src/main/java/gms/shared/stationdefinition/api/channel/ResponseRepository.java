...
/**
 * Interface for providing {@link Response}s; storing {@link Response}s is not allowed by default
 */
public interface ResponseRepository {
  ...
  /**
   * Finds or creates a {@link Response} using {@link
   * gms.shared.stationdefinition.coi.channel.Calibration} values from a {@link WfdiscDao} record
   * found by the provided ID. If the {@link Response} was previously bridged then this operation
   * returns a version reference to that {@link Response}. If the {@link Response} was not
   * previously bridged then this operation returns the fully populated {@link Response} object.
   *

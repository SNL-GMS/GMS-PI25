...
class EventDaoTest {
  ...
  void testBuilderSadEventName() {
    ...
    happyBuilder.withEventName(null);
    assertThrows(NullPointerException.class, () -> happyBuilder.build());

    happyBuilder.withEventName("");
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withEventName("123456789*123456789*123456789*123");
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadPreferredOrigin() {
    ...
    happyBuilder.withPreferredOrigin(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadAuthor() {
    ...
    happyBuilder.withAuthor("123456789*123456");
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }

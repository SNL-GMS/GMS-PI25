import { Displays, SohTypes, StationTypes } from '@gms/common-model';
...
} from '../../../../src/ts/app/state/data-acquisition/types';
...
describe('state data acquisition slice', () => {
  ...
  describe('actions', () => {
    ...
    it('should reset drill down filters', () => {
      const action: Redux.AnyAction = {
        type: dataAcquisitionSlice.actions.resetDrillDownsFiltersToDefault.type
      };
      ...
      store.dispatch(dataAcquisitionSlice.actions.resetDrillDownsFiltersToDefault());

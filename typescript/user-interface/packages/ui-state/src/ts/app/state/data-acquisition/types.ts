...
/** Columns for Statistics Display Table, used for filter */
export enum Columns {
  Station = 'Station',
...
/** The initial selection in the columns drop down */
export const initialStationStatisticsColumnsToDisplay = {
  [Columns.Station]: true,
  [Columns.ChannelIssues]: true,
  [Columns.ChannelLag]: true,
  [Columns.ChannelMissing]: true,
  [Columns.ChannelTimeliness]: true,
  [Columns.StationIssues]: true,
  [Columns.StationLag]: true,
  [Columns.StationMissing]: true,
  [Columns.StationTimeliness]: true
};
...
export const initialFiltersToDisplayDrillDown: Record<FilterableSOHTypesDrillDown, boolean> = {
  [FilterableSOHTypes.GOOD]: true,
  [FilterableSOHTypes.BAD]: true,
  [FilterableSOHTypes.MARGINAL]: true
};
...
export interface DataAcquisitionState {
  ...
  stationStatisticsColumns: Record<Columns, boolean>;
  data: {
    sohStatus: SohStatus;
  };

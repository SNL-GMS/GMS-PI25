...
class ReferenceAliasTest {
  ...
  void testSerialization() throws Exception {
    TestUtilities.testSerialization(
        StationReferenceTestFixtures.STATION_ALIAS, ReferenceAlias.class);
  }

  @Test
  void testReferenceStationAliasCreateNullArguments() throws Exception {
    TestUtilities.checkStaticMethodValidatesNullArguments(
        ReferenceAlias.class, "create", name, status, comment, actualTime, systemTime);
  }

  @Test
  void testReferenceStationAliasFromNullArguments() throws Exception {
    TestUtilities.checkStaticMethodValidatesNullArguments(
        ReferenceAlias.class, "from", id, name, status, comment, actualTime, systemTime);
  }

  @Test
  void testReferenceStationAliasCreate() {
    ReferenceAlias alias = ReferenceAlias.create(name, status, comment, actualTime, systemTime);
  ...
  void testReferenceStationAliasFrom() {
    ReferenceAlias alias = ReferenceAlias.from(id, name, status, comment, actualTime, systemTime);

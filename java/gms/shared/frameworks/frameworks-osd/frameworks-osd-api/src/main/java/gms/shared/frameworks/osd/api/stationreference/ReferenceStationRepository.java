...
/** Interface for the endpoint that returns and stores {*link ReferenceStation}s */
public interface ReferenceStationRepository {

  /**
   * Retrieves all {@link ReferenceStation} objects corresponding to given list of entity ids.If an
   * empty List is provided, all reference stations will be retrieved.
   *
   * @param entityIds a list of the ids of interest
   * @return all stations
   */
  ...
  @Operation(
      summary =
          "retrieves the given collection of reference stations that correspond to "
  ...
  @Produces(ContentType.JSON_NAME)
  @Operation(
      summary = "Retrieve all reference stations corresponding to the given collection of names.")
  ...
  Map<UUID, List<ReferenceStationMembership>> retrieveStationMembershipsByStationId(
      @RequestBody(
              description =
                  "list of station Ids for which we return the corresponding "
  ...
  Map<UUID, List<ReferenceStationMembership>> retrieveStationMembershipsBySiteId(
      @RequestBody(
              description =
                  "list of site Ids for which we return the corresponding set of "

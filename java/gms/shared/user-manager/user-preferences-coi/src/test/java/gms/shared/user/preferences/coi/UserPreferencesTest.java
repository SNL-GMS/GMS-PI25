...
class UserPreferencesTest {
  ...
  void testSerialization() throws IOException {
    ...
    assertEquals(
        preferences,
        mapper.readValue(mapper.writeValueAsString(preferences), UserPreferences.class));
  }
  ...
  void testNullNotificationListValidation() {
    assertThrows(
        IllegalArgumentException.class, this::buildUserPreferencesWithDuplicateMessageType);
  }

  @Test
  void testDuplicateMessageTypeValidation() {
    assertThrows(
        IllegalArgumentException.class, this::buildUserPreferencesWithNullNotificationList);
  }

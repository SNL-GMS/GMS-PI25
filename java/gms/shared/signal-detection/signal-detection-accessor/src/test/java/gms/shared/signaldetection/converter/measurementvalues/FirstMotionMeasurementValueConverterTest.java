...
class FirstMotionMeasurementValueConverterTest
  ...
  private static final FirstMotionMeasurementValue VALUE_1 =
      FirstMotionMeasurementValue.from(
          FirstMotionType.COMPRESSION, Optional.empty(), Optional.of(Instant.EPOCH));
  private static final FirstMotionMeasurementValue VALUE_21 =
      FirstMotionMeasurementValue.from(
          FirstMotionType.COMPRESSION, Optional.empty(), Optional.of(Instant.EPOCH.plusSeconds(1)));
  private static final FirstMotionMeasurementValue VALUE_22 =
      FirstMotionMeasurementValue.from(
          FirstMotionType.DILATION, Optional.empty(), Optional.of(Instant.EPOCH.plusSeconds(1)));
  private static final FirstMotionMeasurementValue VALUE_3 =
      FirstMotionMeasurementValue.from(
          FirstMotionType.DILATION, Optional.empty(), Optional.of(Instant.EPOCH));
  private static final FirstMotionMeasurementValue VALUE_4 =
      FirstMotionMeasurementValue.from(
          FirstMotionType.INDETERMINATE,
          Optional.empty(),
  ...
  void testConvert(
      FirstMotionMeasurementValue expectedValue,
      MeasurementValueSpec<FirstMotionMeasurementValue> spec) {
  ...
  static Stream<Arguments> getConvertValidationArguments() {
    MeasurementValueSpec<FirstMotionMeasurementValue> spec1 =
    ...
    return Stream.of(arguments(NoSuchElementException.class, spec1));
  }

  static Stream<Arguments> getTestConvertArguments() {

    // Create the measurement value specs for multiple converters
    MeasurementValueSpec<FirstMotionMeasurementValue> measurementValueSpec1 =
        MeasurementValueSpec.<FirstMotionMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_1)
            .setFeatureMeasurementType(FeatureMeasurementTypes.SHORT_PERIOD_FIRST_MOTION)
            .setFeatureMeasurementTypeCode("c")
            .build();
    MeasurementValueSpec<FirstMotionMeasurementValue> measurementValueSpec21 =
        MeasurementValueSpec.<FirstMotionMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_2)
            .setFeatureMeasurementType(FeatureMeasurementTypes.SHORT_PERIOD_FIRST_MOTION)
            .setFeatureMeasurementTypeCode("c")
            .build();
    MeasurementValueSpec<FirstMotionMeasurementValue> measurementValueSpec22 =
        MeasurementValueSpec.<FirstMotionMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_2)
            .setFeatureMeasurementType(FeatureMeasurementTypes.LONG_PERIOD_FIRST_MOTION)
            .setFeatureMeasurementTypeCode("r")
            .build();
    MeasurementValueSpec<FirstMotionMeasurementValue> measurementValueSpec3 =
        MeasurementValueSpec.<FirstMotionMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_3)
            .setFeatureMeasurementType(FeatureMeasurementTypes.LONG_PERIOD_FIRST_MOTION)
            .setFeatureMeasurementTypeCode("r")
            .build();
    MeasurementValueSpec<FirstMotionMeasurementValue> measurementValueSpec4 =
        MeasurementValueSpec.<FirstMotionMeasurementValue>builder()

 ...
 *
 * <p>Corresponds to SOURCE_TO_RECEIVER_AZIMUTH, RECEIVER_TO_SOURCE_AZIMUTH, SLOWNESS,
...
public abstract class NumericMeasurementValue {
  ...
  public static NumericMeasurementValue fromFeatureMeasurement(
      Instant referenceTime, DoubleValue measuredValue) {
    return from(Optional.of(referenceTime), measuredValue);
  }

  public static NumericMeasurementValue fromFeaturePrediction(DoubleValue measuredValue) {

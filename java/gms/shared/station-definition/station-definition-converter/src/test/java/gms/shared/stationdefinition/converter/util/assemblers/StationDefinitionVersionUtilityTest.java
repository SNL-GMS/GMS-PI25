...
class StationDefinitionVersionUtilityTest {
  ...
  @Test
  void testGetWfDiscsWithNextVersionNextWfdiscSameVersion() {
    WfdiscDao wfdiscChangeCalper =
        createWfdiscDao(STA1, CHAN1, ONDATE3, ONDATE4, WFID_3, CHANID_3, WFDISC_PARAM_MAP);
    List<WfdiscDao> updatedWfdisc =
        StationDefinitionVersionUtility.getWfDiscsWithNextVersion(
  ...
  @Test
  void testGetWfDiscsWithNextVersionNextWfdiscNewVersion() {
    Map<WFDISC_ARGS, Number> WFDISC_PARAM_MAP_CHANGE_CALIBPER =
        Map.ofEntries(
    ...
    WfdiscDao wfdiscChangeCalper =
        createWfdiscDao(
            STA1, CHAN1, ONDATE3, ONDATE4, WFID_3, CHANID_3, WFDISC_PARAM_MAP_CHANGE_CALIBPER);
    List<WfdiscDao> updatedWfdisc =
        StationDefinitionVersionUtility.getWfDiscsWithNextVersion(
            List.of(WFDISC_TEST_DAO_5, wfdiscChangeCalper));
    assertEquals(1, updatedWfdisc.size());
  ...
  @Test
  void testGetWfDiscsWithNextVersionEmptyList() {
    List<WfdiscDao> updatedWfdisc =
        StationDefinitionVersionUtility.getWfDiscsWithNextVersion(List.of());
    assertEquals(0, updatedWfdisc.size());
  }

  @Test
  void testGetWfDiscsWithNextVersionNull() {
  ...
  @Test
  void testGetSensorsWithVersionEndTime() {
    SensorDao sensorDao =
  ...
  @Test
  void testGetSensorsWithVersionEndTimeEmptyList() {
    List<SensorDao> updatedSensor =
        StationDefinitionVersionUtility.getSensorsWithVersionEndTime(List.of());
    assertEquals(0, updatedSensor.size());
  }

  @Test
  void testGetSensorsWithVersionEndTimeNull() {
    Assertions.assertThrows(
        NullPointerException.class,
  ...
  @Test
  void testGetVersionMapAsIntWithSameVersionAttributeHash() {
    List<WfdiscDao> wfdiscDaos = List.of(WFDISC_TEST_DAO_1, WFDISC_TEST_DAO_4);

    Map<Integer, List<WfdiscDao>> wfdiscDaoByVersionMap =
  ...
  @Test
  void testGetVersionMapAsIntWithDifferentVersionAttributeHash() {
  ...
  @Test
  void testGetVersionMapWithDifferentVersionAttributeHash() {
    List<WfdiscDao> wfdiscDaos = List.of(WFDISC_TEST_DAO_1, WFDISC_TEST_DAO_2);

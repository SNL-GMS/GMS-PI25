...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = FkSpectra.class, name = "FK_SPECTRA_OLD"),
  @JsonSubTypes.Type(value = gms.shared.waveform.coi.fk.FkSpectra.class, name = "FK_SPECTRA")
})

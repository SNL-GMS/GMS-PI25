...
CREATE TABLE IF NOT EXISTS GMS_GLOBAL.AMPLITUDE_DYN_PARS_INT
(	
AMPID NUMBER(18,0) NOT NULL,
GROUP_NAME VARCHAR2(48) NOT NULL,
PARAM_NAME VARCHAR2(48) NOT NULL,
I_VALUE NUMBER(18,0) NOT NULL,
LDDATE DATE NOT NULL,
CONSTRAINT AMPLITUDE_DYN_PARS_INT_PK PRIMARY KEY (AMPID, GROUP_NAME, PARAM_NAME),

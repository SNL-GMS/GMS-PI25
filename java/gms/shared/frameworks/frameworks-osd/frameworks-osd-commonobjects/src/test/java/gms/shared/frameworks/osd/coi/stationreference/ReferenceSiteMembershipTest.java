...
class ReferenceSiteMembershipTest {
  ...
  void testSerialization() throws Exception {
    TestUtilities.testSerialization(
        StationReferenceTestFixtures.REFERENCE_SITE_MEMBERSHIP, ReferenceSiteMembership.class);
  }
  ...
  void testReferenceSiteMembCreateNullArguments() throws Exception {
    TestUtilities.checkStaticMethodValidatesNullArguments(
        ...
        systemTime,
        siteId,
        StationReferenceTestFixtures.CHANNEL_NAME,
        status);
  }

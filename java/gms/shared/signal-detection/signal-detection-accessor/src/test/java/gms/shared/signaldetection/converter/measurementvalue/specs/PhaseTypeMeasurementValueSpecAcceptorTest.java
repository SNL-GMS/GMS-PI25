...
class PhaseTypeMeasurementValueSpecAcceptorTest
    extends MeasurementValueSpecAcceptorTest<PhaseTypeMeasurementValue> {
  protected PhaseTypeMeasurementValueSpecAcceptor converterSpec;

  @Mock private MeasurementValueSpecVisitor<PhaseTypeMeasurementValue> specVisitor;
  ...
  void testAcceptor(
    ...
    testSpecAcceptor(
        ...
        buildSpecVisitorConsumer(
            measurementValueSpec, featureMeasurementType, arrivalDao, assocDao),
        arrivalDao,
        assocDao);
  }

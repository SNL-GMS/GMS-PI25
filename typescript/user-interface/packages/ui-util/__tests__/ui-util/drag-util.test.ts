...
describe('Drag utils', () => {
  ...
  it('store drag data', () => {
    ...
    // eslint-disable-next-line @typescript-eslint/dot-notation, dot-notation
    expect(storeEvent.nativeEvent['dataTransfer']['setData']).toHaveBeenCalledTimes(4);
  });
  ...
  it('store drag', () => {
    ...
    // eslint-disable-next-line @typescript-eslint/dot-notation, dot-notation
    expect(dragImage.nativeEvent['dataTransfer']['setDragImage']).toHaveBeenCalledTimes(1);
  });

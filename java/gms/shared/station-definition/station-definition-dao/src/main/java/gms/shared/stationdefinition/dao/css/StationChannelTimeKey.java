...
public class StationChannelTimeKey implements Serializable {
  ...
  public StationChannelTimeKey(String stationCode, String channelCode, Instant time) {
    this.stationCode =
        Validate.notBlank(stationCode, "StationChannelTimeKey must be provided a station code");
    this.channelCode =
        Validate.notBlank(channelCode, "StationChannelTimeKey must be provided a channel code");

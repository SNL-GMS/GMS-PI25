...
/**
 * Defines the structure of a PredictionsAndBehaviors object - aggregates {@link
 * gms.shared.event.coi.featureprediction.FeaturePrediction}s and {@link LocationBehavior}s
 */
@AutoValue
public abstract class PredictionsAndBehaviors {
  private static final PredictionsAndBehaviors EMPTY =
      PredictionsAndBehaviors.create(FeaturePredictionContainer.of(), emptySet());
  ...
  public static PredictionsAndBehaviors create(
      FeaturePredictionContainer featurePredictions, Set<LocationBehavior> locationBehaviors) {
    return new AutoValue_PredictionsAndBehaviors(featurePredictions, locationBehaviors);
  }

  public static PredictionsAndBehaviors union(
      PredictionsAndBehaviors first, PredictionsAndBehaviors second) {

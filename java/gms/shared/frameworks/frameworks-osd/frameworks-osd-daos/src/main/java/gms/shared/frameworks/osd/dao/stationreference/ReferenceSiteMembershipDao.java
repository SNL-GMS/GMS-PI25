...
public class ReferenceSiteMembershipDao {
  ...
  @GeneratedValue(
      ...
      generator = "reference_site_membership_sequence")
  @SequenceGenerator(
      name = "reference_site_membership_sequence",
      sequenceName = "reference_site_membership_sequence",
      allocationSize = 5)
  ...
  public ReferenceSiteMembership toCoi() {
    return ReferenceSiteMembership.from(
        getId(),
        getComment(),
        getActualTime(),
        getSystemTime(),

...
public abstract class DoubleRange {
   ...
   */
  @JsonCreator
  public static DoubleRange from(@JsonProperty("min") double min, @JsonProperty("max") double max) {
  ...
  public boolean contains(double val, boolean includeMin, boolean includeMax) {
    ...
    boolean satifiesMin = (includeMin && eqMin) || gtMin;
    boolean satifiesMax = (includeMax && eqMax) || ltMax;

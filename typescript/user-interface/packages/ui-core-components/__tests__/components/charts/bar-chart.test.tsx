...
import { buildVictoryChart } from '../../../src/ts/components/charts/bar-chart';
...
describe('Build Scroll Victory Chart', () => {
  it('exists Victory Chart', () => {
    expect(buildVictoryChart).toBeDefined();
  });
  it('exists build scroll Victory Chart', () => {
    expect(buildVictoryChart).toBeDefined();
  });
});

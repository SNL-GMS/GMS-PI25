...
class ReferenceChannelTest {
  ...
  private static final ChannelInstrumentType instrumentType =
  ...
  private static final RelativePosition position = RelativePosition.from(1.1, 2.2, 3.3);

  private static final InformationSource informationSource =
  ...
  void testSerialization() throws Exception {
    TestUtilities.testSerialization(
        StationReferenceTestFixtures.REFERENCE_CHANNEL, ReferenceChannel.class);
  }

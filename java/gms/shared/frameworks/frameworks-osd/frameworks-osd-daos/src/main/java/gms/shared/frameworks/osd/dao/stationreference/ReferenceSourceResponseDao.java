...
public class ReferenceSourceResponseDao {
  ...
  @GeneratedValue(
      ...
      generator = "reference_source_response_sequence")
  @SequenceGenerator(
      name = "reference_source_response_sequence",
      sequenceName = "reference_source_response_sequence",
      allocationSize = 5)
  private long id;
  ...
  @ElementCollection
  @CollectionTable(
      name = "reference_source_response_information_sources",
  ...
  public void setSourceResponseUnits(Units sourceResponseUnits) {

...
/**
 * Convenience record class for storing a value from a kafka {@link
 * reactor.kafka.receiver.ReceiverRecord} with its {@link ReceiverOffset}. Can be used with
 * collections/batch objects and a latest offset to help enable batch processing and committing of
 * kafka messages.
 */
@AutoValue

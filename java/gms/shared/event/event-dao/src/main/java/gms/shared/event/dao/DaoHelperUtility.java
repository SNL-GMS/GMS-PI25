...
public final class DaoHelperUtility {
  ...
  /**
   * Returns a String describing a required numerical range. i.e "It must be the range [5 6]"
   *
  ...
  /**
   * Returns a String describing a required maximum string length. i.e "Length of string must not be
   * greater than 5"
   *
  ...
  /**
   * Returns a String describing a required minimum numerical value. i.e "Must be greater than 5"
   *
  ...
  static <T extends Comparable<T>> void checkRange(
    ...
    checkArgument(
        objectToCheck.compareTo(lowerBound) >= 0 && objectToCheck.compareTo(upperBound) <= 0,
        message);

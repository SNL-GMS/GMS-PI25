...
public class TestUtilitiesTest {
  ...
  @Test
  void testCheckConstructorValidatesNullArguments() {
    TestUtilities.checkConstructorValidatesNullArguments(Test1.class, 1);
  }

  @Test
  void testCheckConstructorValidatesNullArgumentsExpectException() {
    ...
    assertEquals(
        "No validation for argument of type "
            + Integer.class
            + " at parameter index 0 for constructor public"
            + " gms.shared.frameworks.osd.coi.util.TestUtilitiesTest$Test2(java.lang.Integer)",
  ...
  @Test
  void testCheckConstructorValidatesNullArgumentsPrimitiveArgument() {
    TestUtilities.checkConstructorValidatesNullArguments(Test4.class, 1);
  }

  @Test
  void testCheckConstructorValidatesNullArgumentsNoConstructorFound() {
  ...
  void testCheckAllConstructorsValidateNullArguments() {
    TestUtilities.checkAllConstructorsValidateNullArguments(
        Test5.class, new Object[][] {{"Test"}, {1}});
  }

  @Test
  void testCheckAllConstructorsValidateNullArgumentsWhenValidArgsThrowsException() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
  ...
  @Test
  void testCheckAllConstructorsValidateNullArgumentsMissingParameters() {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () ->
                TestUtilities.checkAllConstructorsValidateNullArguments(
                    Test5.class, new Object[][] {{"Test"}}));
    assertEquals(
        "Missing validation arguments for following constructors: "
            + "public gms.shared.frameworks.osd.coi.util.TestUtilitiesTest"
            + "$Test5(java.lang.Integer)",
        exception.getMessage());
  }

  @Test
  void testCheckStaticMethodValidatesNullArguments() throws Exception {
    TestUtilities.checkStaticMethodValidatesNullArguments(
        TestUtilitiesTest.class, "testFactory1", "TestString", 1);
  }

  @Test
  void testCheckStaticMethodValidateNullArgumentsWhenValidArgsThrowsException() throws Exception {
    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () ->
                TestUtilities.checkStaticMethodValidatesNullArguments(
                    TestUtilitiesTest.class, "testFactory5", "TestString", 1));
    assertTrue(
        exception
            .getMessage()
  ...
  void testCheckStaticMethodValidatesNullArgumentsExpectException() throws Exception {
    RuntimeException exception =
        assertThrows(
            ...
            () ->
                TestUtilities.checkStaticMethodValidatesNullArguments(
                    TestUtilitiesTest.class, "testFactory2", "TestString", 1));
    assertTrue(
        exception
            .getMessage()
            .contains(
  ...
  void testCheckStaticMethodValidatesNullArgumentsNullAllowed() throws Exception {
    TestUtilities.checkStaticMethodValidatesNullableArguments(
        TestUtilitiesTest.class, "testFactory2", Collections.singletonList(1), "TestString", 1);
  }
  ...
  void testCheckStaticMethodValidatesNullArgumentsExpectsSuperclassPassesSubclass()
      throws Exception {
    TestUtilities.checkStaticMethodValidatesNullArguments(
        TestUtilitiesTest.class, "testFactory3", "TestString", 1);
  }

  @Test
  void testCheckStaticMethodValidatesNullArgumentsPrimitiveArgument() throws Exception {
    TestUtilities.checkStaticMethodValidatesNullArguments(
        TestUtilitiesTest.class, "testFactory4", "TestString", 1);
  }

...
describe('System Message Component', () => {
  ...
  it('Can check add new system messages and check to update', () => {
    expect(() => checkToUpdateSystemMessages()).not.toThrow();
    expect(() => bufferSystemMessages([systemMessage0, systemMessage1])).not.toThrow();
    expect(() => checkToUpdateSystemMessages()).not.toThrow();
  });
  ...
  it('updates store', () => {
    ...
    expect(clearExpiredSystemMessages).not.toHaveBeenCalled();
    expect(clearSystemMessages).not.toHaveBeenCalled();
    expect(clearAllSystemMessages).not.toHaveBeenCalled();

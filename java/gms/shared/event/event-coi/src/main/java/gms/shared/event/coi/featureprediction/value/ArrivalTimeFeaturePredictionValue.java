 ...
 */
public final class ArrivalTimeFeaturePredictionValue
  ...
  public static ArrivalTimeFeaturePredictionValue from(
      ...
      @JsonProperty("predictedValue") ArrivalTimeMeasurementValue predictedValue,
      @JsonProperty("derivativeMap")
          Map<FeaturePredictionDerivativeType, DoubleValue> derivativeMap,
      @JsonProperty("featurePredictionComponents")
          Set<FeaturePredictionComponent<DurationValue>> featurePredictionComponents) {

    if (!FeatureMeasurementTypes.ARRIVAL_TIME
        .getFeatureMeasurementTypeName()
        .equals(featureMeasurementType.getFeatureMeasurementTypeName())) {
      throw new IllegalArgumentException(
          "ArrivalTimeFeaturePredictionValue can only have an ARRIVAL_TIME FeatureMeasurementType");
    }

...
/**
 * Base signal detection measurement value converter for initializing objects needed for the
 * measurement value converters
 */
public interface MeasurementValueConverter<V> {

  /**
   * Convert {@link MeasurementValueSpec} to corresponding measurement value given by the generic
   * type V
   *

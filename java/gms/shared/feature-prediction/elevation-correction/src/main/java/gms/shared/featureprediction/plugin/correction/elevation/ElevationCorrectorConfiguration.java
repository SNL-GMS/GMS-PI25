  ...
  public ElevationCorrectorDefinition getCurrentElevationCorrectorDefinition() {
    var rawObject =
        configurationConsumerUtility
            .resolve("feature-prediction-elevation-corrector", List.of())
    ...
    if (rawObject instanceof Map) {
      ...
      // To avoid type warnings/code smells just use toString to convert to a map of String ->
      // String
      var nameMap =
      ...
      throw new IllegalStateException(
          "configuration field mediumVelocityEarthModelPluginNameByModelName is not map!");
    }
  }
}

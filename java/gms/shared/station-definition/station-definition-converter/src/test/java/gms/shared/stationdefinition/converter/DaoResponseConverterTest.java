...
class DaoResponseConverterTest {
  ...
  static void prepareObjects() {
    ...
    emptyFrequencyAmplitudePhase =
        FrequencyAmplitudePhase.builder()
            .setData(Optional.empty())
            .setId(UUID.fromString("10000000-100-0000-1000-100000000076"))
            .build();

    String id =
        CSSDaoTestFixtures.WFDISC_DAO_1.getStationCode()
    ...
    sampleEntityResponse = Response.builder().setId(UUID.nameUUIDFromBytes(id.getBytes())).build();
  }
  ...
  void testResponseConverterPassWithEndTimeFromWfDisc() {
    ...
    Response sampleResponseWithEndTime =
        Response.builder()
    ...
    assertEquals(
        sampleResponseWithEndTime,
        daoResponseConverter.convert(
  ...
  void testEntityResponseConverterPass() {
    ...
    assertEquals(sampleEntityResponse, daoResponseConverter.convertToEntity(wfdiscDao));
  }

  @Test
  void testResponseConverterPassWithEntityReferenceFeqAmplitudePhase() {
    assertDoesNotThrow(
        () ->
            daoResponseConverter.convert(
  ...
  void testResponseConverterNullAndEmptyChecks(
  ...
  @Test
  void testResponseConverterToEntityNullAndEmptyChecks() {
    assertThrows(NullPointerException.class, () -> daoResponseConverter.convertToEntity(null));
  }
}

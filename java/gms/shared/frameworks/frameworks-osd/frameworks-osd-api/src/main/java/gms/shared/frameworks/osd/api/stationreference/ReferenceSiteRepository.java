...
/** Interface for the endpoint that returns and stores {*link ReferenceSite}s */
public interface ReferenceSiteRepository {
  ...
  @Operation(
      summary =
          "retrieve all reference site objects corresponding to the given list of entity ids. "
  ...
  /**
   * Retrieves {@link ReferenceSiteMembership} objects corresponding to each {@link ReferenceSite}
   * id.
   *
   * @param siteIds a list of the {@link ReferenceSite} id of interest
  ...
  @Operation(
      summary =
          "Given a list of reference site Ids, "
  ...
  /**
   * Retrieves site memberships with the given channel entity name.
   *
   * @param channelNames the {@link Channel} names of interest
   * @return the memberships
   */
   ...
   *
   * @param request the {@link ReferenceSiteMembershipRequest} containing the ids of interest
   * @return the memberships
   */
  ...
  @Operation(
      summary =
          "retrieves the list of reference site memberships associated with the given "
              + "site and channel")
  List<ReferenceSiteMembership> retrieveSiteMembershipsBySiteIdAndChannelName(
      @RequestBody(
              description =
                  "reference site membership request containing siteId and channelId "

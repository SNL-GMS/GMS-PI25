...
/**
 * Used for turning String's into FeatureMeasurementType's and Class objects. Mainly used for
 * compile-time checking.
 */
public final class FeatureMeasurementTypesChecker {
  ...
  private FeatureMeasurementTypesChecker() {

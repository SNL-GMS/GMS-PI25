...
public class TestUtilities {
  ...
  private static final String NULL_MAPPER_STRING =
      "Cannot test serialization with null object mapper";
  ...
  private static <T> void assertSerializes(
      T object, TypeReference<T> typeReference, ObjectMapper objMapper) {
    assertNotNull(object, NULL_OBJECT_STRING);

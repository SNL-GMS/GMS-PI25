...
class LocationSolutionConverterUtilityTest {
  ...
  void testFromLegacyToLocationSolution() {
    ...
    var actualLocationSolution =
        LocationSolutionConverterUtility.fromLegacyToLocationSolution(ehInfo, singleton(sdhInfo));
  ...
  @Test
  void testFromLegacyToLocationSolutionEmptySdh() {
    var ehInfo = BridgeTestFixtures.DEFAULT_BRIDGED_EH_INFORMATION;
    var sdhInfoWithEmptySdh =
        BridgedSdhInformation.builder()
            .setArInfoDao(
                BridgeTestFixtures.DEFAULT_BRIDGED_SDH_INFORMATION.getArInfoDao().orElseThrow())
            ...
            .build();
    var actualLocationSolution =
        LocationSolutionConverterUtility.fromLegacyToLocationSolution(
            ehInfo, singleton(sdhInfoWithEmptySdh));
  ...
  @Test
  void testFromLegacyToLocationSolutionNoSdhInfo() {

    var ehInfo = BridgeTestFixtures.DEFAULT_BRIDGED_EH_INFORMATION;
    var actualLocationSolution =
        LocationSolutionConverterUtility.fromLegacyToLocationSolution(ehInfo, new HashSet<>());

    assertThat(actualLocationSolution).isNotNull();
    assertEquals(
        LocationRestraint.free(),
        actualLocationSolution.getData().orElseThrow().getLocationRestraint());
    ...
    assertThat(
        ...
        .isEmpty();
    assertTrue(
        actualLocationSolution.getData().orElseThrow().getNetworkMagnitudeSolutions().isEmpty());
  }
}

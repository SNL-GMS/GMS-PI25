...
/**
 * Interface declaring operations for accessing {@link SignalDetection} and {@link
 * SignalDetectionHypothesis} objects
 */
public interface SignalDetectionRepository {

  /**
   * Finds {@link SignalDetection}s for the provided {@link UUID}s and {@link WorkflowDefinitionId}s
   *
  ...
  /**
   * Retrieves {@link SignalDetection}s for the provided stations and stage, between the provided
   * time range, and excluding any of the excluded {@link SignalDetection}s
   *

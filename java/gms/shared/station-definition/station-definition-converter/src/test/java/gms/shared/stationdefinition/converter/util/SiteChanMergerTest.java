...
class SiteChanMergerTest {
  ...
  @Test
  void testMergeSiteChans() {
    var SITE_CHAN_DAO_1 = createSiteChanDao(STA1, CHAN1, ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_1);
    var SITE_CHAN_DAO_2 =
        createSiteChanDao(STA1, CHAN1, OFFDATE, OFFDATE2, CHAN_PARAM_MAP, CHANID_1);
    var SITE_CHAN_DAO_3 =
        createSiteChanDao(STA1, CHAN1, OFFDATE2, OFFDATE3, CHAN_PARAM_MAP, CHANID_1);
    var actual =
        List.of(createSiteChanDao(STA1, CHAN1, ONDATE, OFFDATE3, CHAN_PARAM_MAP, CHANID_1));

    List<SiteChanDao> expected =
        SiteChanMerger.mergeSiteChans(
            Map.of("", List.of(SITE_CHAN_DAO_1, SITE_CHAN_DAO_2, SITE_CHAN_DAO_3)));
  ...
  @Test
  void testGetPossibleVersionTimes() {
    var SITE_CHAN_DAO_1 = createSiteChanDao(STA1, CHAN1, ONDATE, OFFDATE, CHAN_PARAM_MAP, CHANID_1);
    var SITE_CHAN_DAO_2 =
        createSiteChanDao(STA1, CHAN1, OFFDATE2, OFFDATE3, CHAN_PARAM_MAP, CHANID_1);
    ...
    var expected =
        SiteChanMerger.getPossibleVersionTimes(List.of(SITE_CHAN_DAO_1, SITE_CHAN_DAO_2));

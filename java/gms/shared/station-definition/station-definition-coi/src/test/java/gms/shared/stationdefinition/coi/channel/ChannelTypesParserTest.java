...
class ChannelTypesParserTest {
                            ...
                            channelOrientationType ->
                                instrumentType
                                    ...
                                    .orElseGet(
                                        () ->
                                            getChannelTypes(
                                                channelBandType, channelOrientationType)))
                        .or(Optional::empty))
            .or(Optional::empty);
  ...
  private static Stream<Arguments> parseChannelTypesArguments() {
    return Stream.of(
        ...
        arguments(
            "EDH",
            Optional.of(EXTREMELY_SHORT_PERIOD),
        ...
        arguments(
            "BK1",
            Optional.of(BROADBAND),
            Optional.of(TEMPERATURE),
            Optional.of(CABINET_SOURCES_1)),
        arguments(
            "BK2",
            Optional.of(BROADBAND),
            Optional.of(TEMPERATURE),
            Optional.of(CABINET_SOURCES_2)),
        arguments(
            "BK3",
            Optional.of(BROADBAND),
            Optional.of(TEMPERATURE),
            Optional.of(CABINET_SOURCES_3)),
        arguments(
            "BK4",
            Optional.of(BROADBAND),
            Optional.of(TEMPERATURE),
            Optional.of(CABINET_SOURCES_4)),
        arguments(
            "BWD", Optional.of(BROADBAND), Optional.of(WIND), Optional.of(WIND_DIRECTION_VECTOR)),
        ...
        arguments(
            "BHN",
            Optional.of(BROADBAND),
            Optional.of(HIGH_GAIN_SEISMOMETER),
        ...
        arguments(
            "SHZ",
            Optional.of(SHORT_PERIOD),
            Optional.of(HIGH_GAIN_SEISMOMETER),
            Optional.of(VERTICAL)),
        arguments(
            "HHN",
            Optional.of(HIGH_BROADBAND),
            Optional.of(HIGH_GAIN_SEISMOMETER),
            Optional.of(NORTH_SOUTH)),
        arguments(
            "HNN",
            Optional.of(HIGH_BROADBAND),
            Optional.of(ACCELEROMETER),
            Optional.of(NORTH_SOUTH)),
        ...
        arguments(
            "EE", Optional.of(EXTREMELY_SHORT_PERIOD), Optional.empty(), Optional.of(EAST_WEST)),
        arguments(
            "EZ", Optional.of(EXTREMELY_SHORT_PERIOD), Optional.empty(), Optional.of(VERTICAL)),
        // 1 Letter Codes
  ...
  private static Optional<ChannelTypes> getChannelTypes(
  ...
  private static Optional<ChannelTypes> getChannelTypes(
      ChannelBandType bandType, ChannelInstrumentType instrumentType, char orientationCode) {
    ChannelOrientationType orientationType =
        ChannelOrientationType.fromCode(orientationCode, instrumentType.getCode());
    ...
    final Builder builder =
        ChannelTypes.builder()
            ...
            .setDataType(
                ChannelDataTypeConverter.getChannelDataType(instrumentType, orientationCode)
  ...
  private static Optional<ChannelTypes> getChannelTypes(
      ChannelBandType bandType, ChannelOrientationType orientationType) {
    return getChannelTypes(bandType, orientationType.getCode());
  }

  private static Optional<ChannelTypes> getChannelTypes(
      ChannelBandType bandType, char orientationCode) {
    final ChannelOrientationType orientationType = ChannelOrientationType.fromCode(orientationCode);

...
public abstract class FeaturePredictionDefinitionConfigurationOption {
  ...
  public abstract List<FeaturePredictionsDefinitions>
      getPredictionsForLocationSolutionDefinitions();

  @JsonCreator
  public static FeaturePredictionDefinitionConfigurationOption create(
      @JsonProperty("featurePredictionsDefinitions")
          List<FeaturePredictionsDefinitions> featurePredictionsDefinitions) {
    return new AutoValue_FeaturePredictionDefinitionConfigurationOption(
        featurePredictionsDefinitions);
  }
}

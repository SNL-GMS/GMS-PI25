...
import type { StringValueGetter, StringValueGetterParams } from '@gms/ui-core-components';
import { InfiniteTable, useDatasource } from '@gms/ui-core-components';
import type { CellClickedEvent, GridReadyEvent } from 'ag-grid-community';
...
> {
  ...
  > = props => {
    ...
    if (React.isValidElement(child)) {
       ...
       */
      return <>{React.cloneElement(child as React.ReactElement<any>, { datasource })}</>;
    }
    return undefined;
  };

  ...
  public Ak135GlobalMediumVelocityDefinition ak135GlobalMediumVelocityDefinition() {
    var rawObject =
        configurationConsumerUtility
            .resolve("feature-prediction-service.ak135-global-medium-velocity", List.of())
            .get("dataDescriptor");

    if (rawObject instanceof String dataDescriptor) {
      return Ak135GlobalMediumVelocityDefinition.create(dataDescriptor);
    } else {
      throw new IllegalStateException(
          "Ak135GlobalMediumVelocityConfiguration: dataDescriptor is not a String!");
    }
  }

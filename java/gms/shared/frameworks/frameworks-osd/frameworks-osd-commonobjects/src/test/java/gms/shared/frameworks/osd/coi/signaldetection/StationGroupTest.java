...
class StationGroupTest {
  ...
  void testFactoryMethodWithNullStationNameThrowsException() {
    ...
    Exception e =
        assertThrows(
            NullPointerException.class, () -> StationGroup.from(null, "test", stationList));
  }
  ...
  void testFactoryMethodWithEmptyNameThrowsException() {
    ...
    Exception e =
        assertThrows(
            IllegalArgumentException.class, () -> StationGroup.from("", "test", stationList));
  }
  ...
  void testFactoryMethodWithNullStationListThrowsException() {
    Exception e =
        assertThrows(
            NullPointerException.class, () -> StationGroup.from("test", "test description", null));
  }

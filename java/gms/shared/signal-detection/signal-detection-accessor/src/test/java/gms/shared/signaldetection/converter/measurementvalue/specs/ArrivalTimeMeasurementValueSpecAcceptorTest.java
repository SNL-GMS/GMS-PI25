...
class ArrivalTimeMeasurementValueSpecAcceptorTest
    extends MeasurementValueSpecAcceptorTest<ArrivalTimeMeasurementValue> {
  ...
  @Override
  Consumer<MeasurementValueSpecVisitor<ArrivalTimeMeasurementValue>> buildSpecVisitorConsumer(

...
public abstract class PreferredEventHypothesis {
   ...
   * @param preferredBy The name of the analyst marking the hypothesis preferred (should be "System"
   *     for automatic stages)
   * @param preferred the single EventHypothesis that is designated as the PreferredEventHypothesis
   *     for the Event, across all processing stages. Not null.
   */
  @JsonCreator

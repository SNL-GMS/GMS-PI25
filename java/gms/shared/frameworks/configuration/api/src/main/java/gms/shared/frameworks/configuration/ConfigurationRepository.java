...
public interface ConfigurationRepository {
   ...
   * keyPrefix. The returned Collection is empty if no Configurations have keys matching the prefix.
   *
   ...
   * @return {@link Optional} list of new Configuration on success or empty optional if put-all
   *     method fails.

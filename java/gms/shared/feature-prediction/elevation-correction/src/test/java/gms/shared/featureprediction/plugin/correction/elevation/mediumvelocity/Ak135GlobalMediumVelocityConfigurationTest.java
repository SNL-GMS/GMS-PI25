...
class Ak135GlobalMediumVelocityConfigurationTest {
  ...
  void init() {
    ...
    configuration =
        new Ak135GlobalMediumVelocityConfiguration(configurationConsumerUtility, systemConfig);
  }
  ...
  void testGetDefinition() {
    ...
    var expectedDefinition =
        Ak135GlobalMediumVelocityDefinition.create(
            "feature-prediction-models/global-medium-velocity/ak135");

    Assertions.assertEquals(
        expectedDefinition, configuration.ak135GlobalMediumVelocityDefinition());
  }

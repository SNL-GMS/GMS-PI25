...
/** Accessor interface for retrieving {@link Response}s */
public interface ResponseAccessor extends ResponseRepository {

  /**
   * Retrieves {@link Response}s having the provided responseIds, effectiveTime and applies the
   * provided faceting definition to the retrieved {@link Response}s
   *

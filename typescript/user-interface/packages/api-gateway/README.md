...
where _tag_ is the docker image tag you want to use identify your container image (e.g. during development use your username or _develop_). The CI pipeline will assign a version tag to official images used for deployment.
...
where _\<tag\>_ is the docker image tag you assigned when you built the container image.

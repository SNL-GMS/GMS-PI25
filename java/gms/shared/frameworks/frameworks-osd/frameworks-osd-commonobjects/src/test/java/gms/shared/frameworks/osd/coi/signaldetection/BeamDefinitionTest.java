...
class BeamDefinitionTest {
  ...
  void testSerialization() throws Exception {
    TestUtilities.testSerialization(beamDefinition, BeamDefinition.class);
  }

  @Test
  void testAziumithValidation() {
    BeamDefinition.Builder beamDefBuilder = beamDefinition.toBuilder().setAzimuth(-1);
    assertThrows(IllegalStateException.class, () -> beamDefBuilder.build());
  ...
  void testMinimumWaveformsValidation() {
    BeamDefinition.Builder beamDefBuilder =
        beamDefinition.toBuilder().setMinimumWaveformsForBeam(0);
    assertThrows(IllegalStateException.class, () -> beamDefBuilder.build());
  }
}

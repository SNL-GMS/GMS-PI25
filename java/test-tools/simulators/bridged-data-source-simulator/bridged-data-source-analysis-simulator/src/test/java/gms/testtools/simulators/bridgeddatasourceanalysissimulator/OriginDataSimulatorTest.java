...
class OriginDataSimulatorTest {
  ...
  void testLoadDataForOrigin() {
    ...
    verify(bridgedDataSourceRepository, times(32)).store(listArgumentCaptor.capture());
    ...
    assertEquals(
        OriginDataSimulatorTestFixture.happyOrigerrDaoBuilder.build(), daoTypes.get(2).get(0));

    assertEquals(
        OriginDataSimulatorTestFixture.happyEventControlDao.build(), daoTypes.get(3).get(0));

    assertEquals(
        OriginDataSimulatorTestFixture.happyAssocDaoBuilder.build(), daoTypes.get(4).get(0));

    assertEquals(
        OriginDataSimulatorTestFixture.happyArInfoDaoBuilder.build(), daoTypes.get(5).get(0));

    assertEquals(
        OriginDataSimulatorTestFixture.happyNetMagDaoBuilder.build(), daoTypes.get(6).get(0));

...
public abstract class KafkaConfiguration {
  ...
  public <T> ReceiverOptions<String, T> getReceiverOptions(
      Deserializer<T> valueDeserializer, Topic topic) {
    String topicValue =
        getTopic(topic)
            .orElseThrow(
                () ->
                    new IllegalArgumentException(
                        format(
                            "Error creating Kafka Receiver Options: no topic found for %s",
                            topic)));
  ...
  public <T> ReceiverOptions<String, T> getReceiverOptions(
      Deserializer<T> valueDeserializer, String topic) {
  ...
  public static KafkaConfiguration create(SystemConfig systemConfig) {
    return KafkaConfiguration.builder()
        ...
        .setHeartbeatInterval(
            systemConfig.getValueAsInt("reactor-kafka-consumer-heartbeat-interval"))
        .build();
  }

...
// BW_LP_CAUSAL_FILTER
const BW_LP_CAUSAL_DESIGNED_FILTER_PARAMETERS: LinearFilterParameters = {
  sampleRateHz: 40,
...
const BW_HP_NONCAUSAL_DESIGNED_FILTER_PARAMETERS: LinearFilterParameters = {
  sampleRateHz: 40,
  sampleRateToleranceHz: 0,
  groupDelaySec: 0,
  aCoefficients: [
...
// BW_BP_CAUSAL
const BW_BP_CAUSAL_DESIGNED_FILTER_PARAMETERS: LinearFilterParameters = {
  sampleRateHz: 40,
  sampleRateToleranceHz: 0,
  groupDelaySec: 0,
  aCoefficients: [
...
const BW_BR_NONCAUSAL_DESIGNED_FILTER_PARAMETERS: LinearFilterParameters = {
  sampleRateHz: 40,
  sampleRateToleranceHz: 0,
  groupDelaySec: 0,
  aCoefficients: [

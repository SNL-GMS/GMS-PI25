...
abstract class SeedMetadata {
  ...
  public static SeedMetadata create(
      Instant adjustedSeedDataStartTime,
      Instant adjustedSeedDataEndTime,
      Duration adjustedSeedDuration,
      int numberForwardSeeds,
      int numberBackwardSeeds) {

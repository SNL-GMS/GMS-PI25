...
export interface HotKeysConfiguration {
  /** Hot key for creating a new signal detection with the current phase */
  createSignalDetectionWithCurrentPhase?: HotKeyConfiguration;

  /** Hot key for creating a new signal detection with the default phase */
  createSignalDetectionWithDefaultPhase?: HotKeyConfiguration;

  /** Hot key for creating a new signal detection not associated to a waveform with the current phase */
  createSignalDetectionNotAssociatedWithWaveformCurrentPhase?: HotKeyConfiguration;

  /** Hot key for creating a new signal detection not associated to a waveform with the default phase */
  ...
  /** Hot key for resetting amplitude of selected channels */
  ...
  /** hot key for hiding the measure window */
  ...
  /** Hot key for zooming out completely */
  zoomOutFully?: HotKeyConfiguration;

  /** Hot key for editing uncertainty bars */
  editSignalDetectionUncertainty?: HotKeyConfiguration;

  /** Hot key for toggling time uncertainty visibility */
  toggleUncertainty?: HotKeyConfiguration;

  /**  Hot key for zooming in */
  zoomOutOneStep?: HotKeyConfiguration;

  /**  Hot key for zooming out */
  zoomInOneStep?: HotKeyConfiguration;

  /** Hot key for panning left */
  panLeft?: HotKeyConfiguration;

  /**  Hot key for for panning right */
  ...
  /**  Hot key for for toggling the current phase menu */
  toggleCurrentPhaseMenu?: HotKeyConfiguration;

  /** Hot key to close the create signal detection overlay */

 ...
 * maximum value).
 *
 * <p>When the maximum time of year value occurs prior to the minimum time of year value,
 ...
 */
@AutoValue
public abstract class TimeOfYearRangeConstraint
    implements Constraint<TimeOfYearRange, LocalDateTime> {
  ...
  public static TimeOfYearRangeConstraint from(
    ...
    return new AutoValue_TimeOfYearRangeConstraint(
        ConstraintType.TIME_OF_YEAR_RANGE, criterion, operator, priority, value);
  }

...
public abstract class Calibration {
  ...
  public static Calibration from(
    ...
    Objects.requireNonNull(
        calibrationPeriodSec, "Cannot create Calibration from null calibrationPeriodSec");
    Objects.requireNonNull(
        calibrationTimeShift, "Cannot create Calibration from null calibrationTimeShift");
    Objects.requireNonNull(
        calibrationFactor, "Cannot create Calibration from null calibrationFactor");

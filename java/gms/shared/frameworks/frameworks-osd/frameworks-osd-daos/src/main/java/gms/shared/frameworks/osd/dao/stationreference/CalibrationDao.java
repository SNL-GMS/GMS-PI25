...
public class CalibrationDao {
  ...
  @SequenceGenerator(
      ...
      sequenceName = "calibration_sequence",
      allocationSize = 5)
  private long id;
  ...
  @AttributeOverride(
      name = "value",
      column = @Column(name = "calibration_factor_value", nullable = false))
  @AttributeOverride(
      name = "standardDeviation",
      column = @Column(name = "calibration_factor_error", nullable = false))
  @AttributeOverride(
      name = "units",
      column = @Column(name = "calibration_factor_units", nullable = false))
  ...
  public static CalibrationDao from(Calibration calibration) {
    Preconditions.checkNotNull(calibration, "Cannot create CalibrationDao from null Calibration");
  ...
  public Calibration toCoi() {
    ...
    return Calibration.from(
        this.calibrationPeriodSec, this.calibrationTimeShift, this.calibrationFactor.toCoi());
  }
  ...
  public void setCalibrationFactor(DoubleValueDao calibrationFactor) {
    this.calibrationFactor = calibrationFactor;
  }

...
public abstract class EventsWithDetectionsAndSegmentsByTimeRequest {
  ...
  /**
   * Gets the beginning of the time range for which to retrieve Events, SignalDetections, and
   * ChannelSegments
   *
  ...
  /**
   * Gets the end of the time range for which to retrieve Events, SignalDetections, and
   * ChannelSegments
   *
   ...
   *     SignalDetections, and ChannelSegments
   * @param endTime The end of the time range for which to retrieve Events, SignalDetections, and
   *     ChannelSegments

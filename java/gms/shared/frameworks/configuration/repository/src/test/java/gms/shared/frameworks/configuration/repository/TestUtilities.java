...
public class TestUtilities {
  ...
  private static NumericScalarConstraint snrIs10 =
      NumericScalarConstraint.from("sta", Operator.from(Type.EQ, false), 5.0, 100);

  private static ConfigurationOption configOptSnrIs10 =
      ConfigurationOption.from("SNR-10", List.of(snrIs10), Map.of("a", 10));

  public static Configuration configurationFilter =
      Configuration.from("Filter", List.of(configOptSnrIs10));
  ...
  public static <T extends Throwable> void expectExceptionAndMessage(

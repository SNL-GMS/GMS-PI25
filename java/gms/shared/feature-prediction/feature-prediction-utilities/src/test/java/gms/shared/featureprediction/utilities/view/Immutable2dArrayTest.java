...
class Immutable2dArrayTest {
  ...
  void testGetValue() {
    ...
    Assertions.assertThrows(
        IndexOutOfBoundsException.class, () -> immutableDoubleArray.getValue(rowCount, 1));

    Assertions.assertThrows(
        IndexOutOfBoundsException.class, () -> immutableDoubleArray.getValue(1, columnCount));
  }
  ...
  void testEmptyArray() {
    ...
    Assertions.assertThrows(
        IndexOutOfBoundsException.class, () -> immutableDoubleArray2.getValue(0, 0));
  }
  ...
  void testEmptyFirstRow() {
    ...
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> Immutable2dArray.from(Double.class, values2));
  }
  ...
  void testNotEquals() {
    // Test class path
    Assertions.assertNotEquals(immutableDoubleArray, immutableDoubleArray.rowCount());

    // Test null path
    Immutable2dArray<Double> nullArray = null;
    Assertions.assertNotEquals(immutableDoubleArray, nullArray);
  }
}

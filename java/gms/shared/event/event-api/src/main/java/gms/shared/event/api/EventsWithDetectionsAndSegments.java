...
/**
 * Defines the response body for the findEventsWithDetectionsAndSegmentsByTime operations.
 * Associates a Set of Events with a SignalDetectionsWithChannelSegments.
 */
@AutoValue
...
public abstract class EventsWithDetectionsAndSegments {
  ...
  public interface Builder {
    ...
    @JsonUnwrapped
    Builder setDetectionsWithChannelSegments(
        SignalDetectionsWithChannelSegments signalDetectionsWithChannelSegments);

...
public class RelativePositionDao {
  ...
  private RelativePositionDao(
      double northDisplacementKm, double eastDisplacementKm, double verticalDisplacementKm) {
  ...
  public static RelativePositionDao from(RelativePosition relativePosition) {
    ...
    return new RelativePositionDao(
        relativePosition.getNorthDisplacementKm(),

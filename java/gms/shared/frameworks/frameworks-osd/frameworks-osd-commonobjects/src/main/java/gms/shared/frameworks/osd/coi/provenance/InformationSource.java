...
public abstract class InformationSource {
  ...
  public static InformationSource from(
    ...
    Objects.requireNonNull(
        informationTime, "Cannot create InformationSource from null informationTime");
    Objects.requireNonNull(reference, "Cannot create InformationSource from null reference");

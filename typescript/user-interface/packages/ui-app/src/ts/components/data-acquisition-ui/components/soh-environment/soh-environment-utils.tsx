...
export const getEnvironmentTableRows = (
  ...
  Object.keys(SohTypes.SohMonitorType)
    ...
    .map(key => {
      ...
      const sohStatusContributor = sohStatusContributors?.find(
        t => t.type === SohTypes.SohMonitorType[key]
      );
      return {
        id: key,
        ...
        monitorStatus: mvsForMonitorType
          ...
          .reduce(getWorseStatus, SohTypes.SohStatusSummary.NONE),
        monitorIsContributing:
          sohStatusContributor && sohStatusContributor.contributing
            ? sohStatusContributor.contributing
            : false,

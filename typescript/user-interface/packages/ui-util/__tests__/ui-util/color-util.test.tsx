...
describe('Color utils', () => {
  ...
  it('can lighten hex colors', () => {
    const percent = 0.5;
    expect(ColorUtils.lightenColor('#182026', 0)).toEqual('#182026');
    expect(ColorUtils.lightenColor('#182026', 1)).toEqual('#ffffff');
    expect(ColorUtils.lightenColor('#182026', percent)).toEqual('#8c9093');
  });

  it('can darken hex colors', () => {
    const percent = 0.5;
    expect(ColorUtils.darkenColor('#182026', 0)).toEqual('#182026');
    expect(ColorUtils.darkenColor('#182026', 1)).toEqual('#000000');
    expect(ColorUtils.darkenColor('#182026', percent)).toEqual('#0c1013');
  });
});

...
class OriginSimulatorDatabaseConnectorTest
    extends SimulatorDatabaseConnectorTest<OriginSimulatorDatabaseConnector> {

  @Override
  protected OriginSimulatorDatabaseConnector getDatabaseConnector(
  ...
  void testFindOriginDaosByPreciseTime() {
    ...
    var result =
        databaseConnector.findOriginDaosByPreciseTime(
            Instant.ofEpochSecond(1629600001), Instant.ofEpochSecond(1629600002));
  ...
  void testRetrieveEventControlDaoByEventIdAndOriginId() {
    ...
    var result =
        databaseConnector.retrieveEventControlDaoByEventIdAndOriginId(
            new EventIdOriginIdKey.Builder().withOriginId(11111).withEventId(1111).build());
  ...
  void testRetrieveArInfoDaoListForOriginId() {
    ...
    assertEquals(expectedArInfoDaoList, result);
  }

  @Test
  void testRetrieveAssocDaoListFromOriginId() {

    var expectedAssocDaoList =
        List.of(
            new AssocDao.Builder()
                .withId(new AridOridKey.Builder().withOriginId(11111).withArrivalId(1).build())
                .withStationCode("AA")
                .withPhase("P")
                .withBelief(1.0)
                .withDelta(1.0)
  ...
  void testRetrieveStamagDaoListForOriginId() {
    ...
    assertEquals(expectedStamagDaoList, result);
  }
}

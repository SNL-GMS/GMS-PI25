...
/**
 * The Event FacetingTypes enum defines the keys and values used to build the faceted objects. keys
 * represent the JSON key names of the facet-able attributes type represents class names of the
 * associated keys
 */
public enum FacetingTypes {
  ...
  CHANNEL_SEGMENT_TYPE(
      gms.shared.stationdefinition.facet.FacetingTypes.CHANNEL_SEGMENT_TYPE.toString()),
  ...
  NETWORK_MAGNITUDE_SOLUTIONS_KEY("networkMagnitudeSolutionsChannel"),
  STATION_KEY("station"),
  CHANNEL_KEY("channel"),

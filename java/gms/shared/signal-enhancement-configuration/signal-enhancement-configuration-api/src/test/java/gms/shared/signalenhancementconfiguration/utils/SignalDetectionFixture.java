...
public class SignalDetectionFixture {
  ...
  public static final DoubleValue standardDoubleValue =
      DoubleValue.from(5, Optional.of(1.0), Units.SECONDS);
  ...
  public static final AmplitudeMeasurementValue amplitudeMeasurement =
      AmplitudeMeasurementValue.fromFeaturePrediction(standardDoubleValue, Duration.ofMillis(1));
  ...
  public static final DoubleValue AMPLITUDE_DOUBLE_VALUE =
      DoubleValue.from(AMPLITUDE_DAO.getAmplitude(), Optional.empty(), CORRESPONDING_UNITS);

  public static final AmplitudeMeasurementValue AMPLITUDE_MEASUREMENT_VALUE =
      AmplitudeMeasurementValue.from(
          AMPLITUDE_DOUBLE_VALUE,

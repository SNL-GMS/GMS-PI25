...
/**
 * A protocol for decoding HTTP response body content. Wire is the type of the data on the wire,
 * e.g. String or byte[].
 *
...
interface ResponseContentProtocol<W> {
  ...
  /**
   * A body handler for W. This is typically implemented using a method on BodyHandler, e.g.
   * BodyHandler.asString().
   */
  BodyHandler<W> bodyHandler();

  /**
   * Deserializes data from the wire into the specified type. This is typically implemented using a

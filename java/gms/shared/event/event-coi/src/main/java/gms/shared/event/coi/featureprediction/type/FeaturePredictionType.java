...
/**
 * Class for an instantiable object that represents the type of feature prediction. Each "type" is
 * associated with a FeaturePredictionValue class; together, they fully define what each type of
...
public abstract class FeaturePredictionType<T extends FeaturePredictionValue<?, ?, ?>> {
  ...
  public static final FeaturePredictionType<ArrivalTimeFeaturePredictionValue>
      ARRIVAL_TIME_PREDICTION_TYPE =
  ...
  public static final FeaturePredictionType<NumericFeaturePredictionValue>
      SLOWNESS_PREDICTION_TYPE =
  ...
  public static final FeaturePredictionType<NumericFeaturePredictionValue>
      EMERGENCE_ANGLE_PREDICTION_TYPE =
  ...
  public static final FeaturePredictionType<NumericFeaturePredictionValue>
      RECEIVER_TO_SOURCE_AZIMUTH_PREDICTION_TYPE =
  ...
  public static final FeaturePredictionType<NumericFeaturePredictionValue>
      SOURCE_TO_RECEIVER_AZIMUTH_PREDICTION_TYPE =
  ...
  public static final FeaturePredictionType<NumericFeaturePredictionValue>
      SOURCE_TO_RECEIVER_DISTANCE_PREDICTION_TYPE =
  ...
  private FeaturePredictionType(TypeNames name) {
    this.name = name;
  }
  ...
  public String toString() {
    return "FeaturePredictionType{" + "name='" + name + '\'' + '}';
  }

  public abstract Class<T> getTypeValueClass();

  /**
   * Custom deserializer used by Jackson. The serialized JSON should contain a single field with a
   * single string that is the name of one of the types, and that string will be returned be
   * JsonParser::getValueAsString.
   */
  static class Deserializer extends StdDeserializer<FeaturePredictionType<?>> {

    private static final Map<TypeNames, FeaturePredictionType<?>> nameTypeMap =
        Map.of(

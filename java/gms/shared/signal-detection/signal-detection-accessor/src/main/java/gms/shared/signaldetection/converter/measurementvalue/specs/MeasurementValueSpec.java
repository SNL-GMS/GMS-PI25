...
public abstract class MeasurementValueSpec<V> {
  ...
  public abstract static class Builder<V> {
    ...
    public abstract Builder<V> setFeatureMeasurementType(
        FeatureMeasurementType<V> featureMeasurementType);

    public abstract Builder<V> setArrivalDao(ArrivalDao arrivalDao);

    public abstract Builder<V> setFeatureMeasurementTypeCode(
        Optional<String> featureMeasurementTypeCode);

    public abstract Builder<V> setFeatureMeasurementTypeCode(String featureMeasurementTypeCode);

    public abstract Builder<V> setMeasuredValueExtractor(
        Optional<ToDoubleFunction<ArrivalDao>> measuredValueExtractor);

    public abstract Builder<V> setMeasuredValueExtractor(
        ToDoubleFunction<ArrivalDao> measuredValueExtractor);

    public abstract Builder<V> setUncertaintyValueExtractor(
        Optional<ToDoubleFunction<ArrivalDao>> uncertaintyValueExtractor);

    public abstract Builder<V> setUncertaintyValueExtractor(
        ToDoubleFunction<ArrivalDao> uncertaintyValueExtractor);

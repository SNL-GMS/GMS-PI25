...
class DziewonskiGilbertEllipticityCorrectorConfigurationTest {
  ...
  void testGetCurrentDziewonskiGilbertEllipticityCorrectorDefinition() {
    ...
    var expectedDefinition =
        DziewonskiGilbertEllipticityCorrectorDefinition.from(
            Map.of("Model1Name", "PluginForModel1Name"));

    var actualDefinition =
        dziewonskiGilbertEllipticityCorrectorConfiguration

...
/** Repository interface for caching {@link ChannelGroup}s */
public interface ChannelGroupRepository {
   ...
   * @return A list of {@link ChannelGroup}s with the provided names and active between the provided
   *     times
   */

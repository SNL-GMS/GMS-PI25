...
class ControlFactoryWorkerTest {

  private final ControlFactoryWorker worker = new ControlFactoryWorker();

  @Mock private ControlContext mockControlContext;
  ...
  void testCreateControlNullControlContextExpectNullPointerException() {
    assertEquals(
        "controlContext must be non-null",
        assertThrows(NullPointerException.class, () -> worker.createControl(String.class, null))
            .getMessage());
  }
  ...
  private void verifySingleValidCreatorOperation(Class<?> controlClass) {
    assertEquals(
        ...
        assertThrows(
                ...
                () -> worker.createControl(controlClass, mockControlContext))
            .getMessage());
  }

 ...
 *
 * <p>Corresponds to AMPLITUDE_A5_OVER_2 FeatureMeasurementType
 */
@AutoValue
public abstract class AmplitudeMeasurementValue {
  ...
  public static AmplitudeMeasurementValue fromFeaturePrediction(
      DoubleValue amplitude, Duration period) {
    return from(
        amplitude, period, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
  }
}

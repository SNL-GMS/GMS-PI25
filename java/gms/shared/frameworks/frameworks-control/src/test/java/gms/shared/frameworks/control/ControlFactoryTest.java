 ...
 *
 * <p>Tests do not use legitimate control classes because ControlFactoryWorker handles those
 * details. These tests only verify ControlFactory uses the correct ControlFactoryWorker operations.
 */
@ExtendWith(MockitoExtension.class)
class ControlFactoryTest {

  @Mock private ControlFactoryWorker mockWorker;

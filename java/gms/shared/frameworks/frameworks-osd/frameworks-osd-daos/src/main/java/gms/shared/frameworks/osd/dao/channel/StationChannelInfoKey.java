...
public class StationChannelInfoKey implements Serializable {
  ...
  public StationChannelInfoKey(StationDao station, ChannelDao channel) {
  ...
  public boolean equals(Object o) {
    ...
    return station.equals(that.station) && channel.equals(that.channel);
  }
  ...
  public String toString() {
    return "StationChannelInfoKey{" + "station=" + station + ", channel=" + channel + '}';
  }
}

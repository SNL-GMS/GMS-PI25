...
public class InformationSourceDao {
  ...
  public InformationSource toCoi() {
    ...
    return InformationSource.from(
        getOriginatingOrganization(), getInformationTime(), getReference());
  }
  ...
  public boolean equals(Object o) {
    ...
    if (originatingOrganization != null
        ? !originatingOrganization.equals(that.originatingOrganization)
        : (that.originatingOrganization != null)) {
      return false;
    }
    if (informationTime != null
        ? !informationTime.equals(that.informationTime)

...
const positionBuffer = Float64Array.from([0, 100, 25, 102, 50, 104, 75, 105, 100, 130]);
const positionBuffer32 = Float32Array.from([0, 100, 25, 102, 50, 104, 75, 105, 100, 130]);
...
describe('getWaveform', () => {
  ...
  it('Can get boundaries that were previously set', async () => {
    const wavePromise = new Promise<Float64Array>(resolve => {
    ...
    expect(result).toEqual(positionBuffer32);
  });

    ...
    assertAll(
        () ->
            assertThrows(
                ...
                () -> Operator.assertValidOperatorType(operator, type)),
        () ->
            assertThrows(
                NullPointerException.class, () -> Operator.assertValidOperatorType(null, type)),
        () ->
            assertThrows(
                NullPointerException.class,
                () -> Operator.assertValidOperatorType(operator, (Type) null)));
  }

  @Test
  void testAssertValidOperator() {
    Executable assertSuccessTest =
        () -> Operator.assertValidOperatorType(Operator.from(Type.IN, false), Type.EQ, Type.IN);

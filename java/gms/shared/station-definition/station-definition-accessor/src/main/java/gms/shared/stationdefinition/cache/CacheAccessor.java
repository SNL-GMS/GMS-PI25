...
public class CacheAccessor {
  ...
  static final String STATION_GROUP_NAMES_CONFIG =
      "station-definition-manager" + ".station-group-names";
  ...
  public CacheAccessor(
    ...
    Map<String, List<String>> stationGroupMap =
        configurationConsumerUtility.resolve(STATION_GROUP_NAMES_CONFIG, List.of(), Map.class);

...
class MeasurementValueSpecTest<V> {
  ...
  @Mock private FeatureMeasurementType<V> featureMeasurementType;
  ...
  void testSerializationDeserialization() {
    ...
    Optional<ToDoubleFunction<ArrivalDao>> uncertaintyExtractor =
        Optional.of(ArrivalDao::getSlownessUncertainty);
    Optional<Units> units = Optional.of(Units.SECONDS_PER_DEGREE);
    MeasurementValueSpec<?> measurementValueSpec =
        builder
  ...
  void testSerializationDeserializationWithOptionalDaos() {
    ...
    MeasurementValueSpec<?> measurementValueSpec =
        builder
            ...
            .build();
    assertEquals(ARRIVAL_1, measurementValueSpec.getArrivalDao());
    assertEquals(AMPLITUDE_DAO, measurementValueSpec.getAmplitudeDao().get());

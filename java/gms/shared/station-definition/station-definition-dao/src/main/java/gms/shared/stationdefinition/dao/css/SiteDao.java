...
public class SiteDao {
  ...
  public boolean equals(Object o) {
    ...
    return id.equals(that.id)
        ...
        && staType == that.staType
        && Double.compare(degreesNorth, that.degreesNorth) == 0
        && Double.compare(degreesEast, that.degreesEast) == 0

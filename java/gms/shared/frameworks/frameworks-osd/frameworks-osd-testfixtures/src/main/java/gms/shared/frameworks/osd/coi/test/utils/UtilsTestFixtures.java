...
public class UtilsTestFixtures {
  ...
  public static final UUID CHANNEL_SEGMENT_ID =
      UUID.fromString("57015315-f7b2-4487-b3e7-8780fbcfb413");
  ...
  public static final Station STATION =
      Station.from(
          ...
          Map.of(
              CHANNEL.getName(),
              RelativePosition.from(50.0, 5.0, 10.0),
              CHANNEL_TWO.getName(),
              RelativePosition.from(50.0, 5.0, 10.0)),
  ...
  public static final StationGroup STATION_GROUP =
      StationGroup.from(GROUP_NAME, "Test Station Group", List.of(STATION));
  ...
  public static final ChannelInstrumentType instrumentType =
      ChannelInstrumentType.HIGH_GAIN_SEISMOMETER;
  public static final ChannelOrientationType orientationType = ChannelOrientationType.VERTICAL;
  public static final String RAW_CHANNEL_NAME =
      new String(
          new char[] {bandType.getCode(), instrumentType.getCode(), orientationType.getCode()});
  private static final InformationSource infoSource =
      InformationSource.from("IDC", Instant.now(), "IDC");

  public static final ReferenceChannel referenceChannel =
      ReferenceChannel.builder()
          ...
          .setInformationSource(
              InformationSource.from("originating org", Instant.EPOCH, "reference"))
          .build();

  // Raw
  public static final Channel raw =
  ...
  public static final FilterDefinition filterDefinition =
  ...
  public static final Channel fked =
      ChannelFactory.fk(STATION, List.of(raw), FK_SPECTRA_DEFINITION);

...
class ArrivalDataSimulatorTest {
  ...
  void testLoadDataAndCleanup() {
    ...
    when(wftagDatabaseConnector.findWftagsByTagIds(any())).thenReturn(wfTagDaoList);
    ...
    verify(wftagDatabaseConnector, times(4)).findWftagsByTagIds(any());
    ...
    when(arrivalDatabaseConnector.findArrivalsByTimeRange(any(), any())).thenReturn(arrivalDaoList);
    when(wftagDatabaseConnector.findWftagsByTagIds(any())).thenReturn(originalWfTagDaoList1);
    ...
    verify(wftagDatabaseConnector, times(8)).findWftagsByTagIds(any());

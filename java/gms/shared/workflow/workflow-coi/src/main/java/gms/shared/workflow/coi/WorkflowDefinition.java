...
/**
 * A processing configuration class containing a {@link gms.shared.workflow.coi.Workflow} name and
 * its {@link gms.shared.workflow.coi.Stage} names
 */
@AutoValue
public abstract class WorkflowDefinition {
  ...
  /**
   * Gets the {@link gms.shared.workflow.coi.Stage} names contained in the {@link
   * gms.shared.workflow.coi.Workflow}
   *
   * @return The {@link gms.shared.workflow.coi.Stage} names contained in the {@link
   *     gms.shared.workflow.coi.Workflow}
   */

...
class FilterNameTest {
  ...
  void testFilterNamesFromStrings() {
    ...
    assertEquals(
        FilterName.HAM_FIR_BP_0_50_4_00_HZ_NON_CAUSAL, FilterName.fromString(FILTER16_STR));
  }

  @Test
  void testErrorWhenNamedFilteredEntryAndUnfilteredEntryIsPopulated() {
    IllegalArgumentException thrown =
        assertThrows(IllegalArgumentException.class, FilterNameTest::executeNonExistingFilterName);

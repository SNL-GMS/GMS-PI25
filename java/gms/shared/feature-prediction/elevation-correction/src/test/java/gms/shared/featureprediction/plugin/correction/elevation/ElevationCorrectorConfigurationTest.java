...
class ElevationCorrectorConfigurationTest {
  ...
  void testGetCurrentElevationCorrectorDefinition() {
    ...
    var elevationCorrectorConfiguration =
        new ElevationCorrectorConfiguration(configurationConsumerUtility);

    var expectedDefinition =
        ElevationCorrectorDefinition.from(Map.of("Model1Name", "PluginForModel1Name"));

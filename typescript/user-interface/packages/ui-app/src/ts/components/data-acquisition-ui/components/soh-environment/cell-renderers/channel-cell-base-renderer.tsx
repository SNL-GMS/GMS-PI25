...
export const ChannelCellBaseRenderer: React.FunctionComponent<React.PropsWithChildren<{
  ...
  <div
    ...
    data-cell-status={getCellStatus(environmentSoh?.status)}
    data-cell-contributing-status={getContributingStatus(environmentSoh?.isContributing).toString()}

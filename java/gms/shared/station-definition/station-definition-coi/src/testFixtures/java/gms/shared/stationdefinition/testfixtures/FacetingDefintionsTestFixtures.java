...
public final class FacetingDefintionsTestFixtures {

  public static final FacetingDefinition STATIONGROUP_POPULATED_FULL =
  ...
  public static final FacetingDefinition STATIONGROUP_CHANNELS_POPULATED =
      FacetingDefinition.builder()
          .setClassType(STATION_GROUP_TYPE.getValue())
          .setPopulated(true)
          .addFacetingDefinitions(
  ...
  public static final FacetingDefinition STATIONGROUP_POPULATED_PARTIAL =
      FacetingDefinition.builder()
          .setClassType(STATION_GROUP_TYPE.getValue())
          .setPopulated(true)
          .addFacetingDefinitions(
  ...
  public static final FacetingDefinition STATIONGROUP_POPULATED_EMPTYFACETS =
      FacetingDefinition.builder()
          .setClassType(STATION_GROUP_TYPE.getValue())
          .setPopulated(true)
          .build();

  public static final FacetingDefinition STATIONGROUP_NOTPOPULATED_EMPTYFACETS =
      FacetingDefinition.builder()
          .setClassType(STATION_GROUP_TYPE.getValue())
          .setPopulated(false)
          .build();
  ...
  public static final FacetingDefinition STATION_POPULATED_EMPTYFACETS =
      FacetingDefinition.builder().setClassType(STATION_TYPE.getValue()).setPopulated(true).build();

  public static final FacetingDefinition STATION_NOTPOPULATED_EMPTYFACETS =
      FacetingDefinition.builder()
          .setClassType(STATION_TYPE.getValue())
          .setPopulated(false)
          .build();

  public static final FacetingDefinition CHANNELGROUP_POPULATED_FULL =
      FacetingDefinition.builder()
          .setClassType(CHANNEL_GROUP_TYPE.getValue())
          .setPopulated(true)
          .addFacetingDefinitions(
  ...
  public static final FacetingDefinition CHANNELGROUP_POPULATED_EMPTYFACETS =
      FacetingDefinition.builder()
          .setClassType(CHANNEL_GROUP_TYPE.getValue())
          .setPopulated(true)
          .build();

  public static final FacetingDefinition CHANNELGROUP_NOTPOPULATED_EMPTYFACETS =
      FacetingDefinition.builder()
          .setClassType(CHANNEL_GROUP_TYPE.getValue())
          .setPopulated(false)
          .build();

  public static final FacetingDefinition CHANNEL_POPULATED_EMPTYFACETS =
      FacetingDefinition.builder().setClassType(CHANNEL_TYPE.getValue()).setPopulated(true).build();

  public static final FacetingDefinition CHANNEL_NOTPOPULATED_EMPTYFACETS =
      FacetingDefinition.builder()
          .setClassType(CHANNEL_TYPE.getValue())
          .setPopulated(false)
          .build();

...
class PhaseTypeMeasurementValueConverterTest
  ...
  void testConvertArrival(
      PhaseTypeMeasurementValue expectedValue,
  ...
  static Stream<Arguments> getTestConvertArgumentsArrival() {
    final PhaseTypeMeasurementValue ptmValue1 =
        PhaseTypeMeasurementValue.fromFeatureMeasurement(
            PhaseType.P, Optional.empty(), Instant.EPOCH);
    final PhaseTypeMeasurementValue ptmValue2 =
        PhaseTypeMeasurementValue.fromFeatureMeasurement(
            PhaseType.I, Optional.empty(), Instant.EPOCH.plusSeconds(100));

    MeasurementValueSpec<PhaseTypeMeasurementValue> measurementValueSpec1 =
        MeasurementValueSpec.<PhaseTypeMeasurementValue>builder()
            ...
            .build();
    MeasurementValueSpec<PhaseTypeMeasurementValue> measurementValueSpec2 =
        MeasurementValueSpec.<PhaseTypeMeasurementValue>builder()
    ...
    return Stream.of(
        arguments(ptmValue1, measurementValueSpec1), arguments(ptmValue2, measurementValueSpec2));
  }

  @ParameterizedTest
  @MethodSource("getTestConvertArgumentsAssoc")
  void testConvertAssoc(
      PhaseTypeMeasurementValue expectedValue,
      MeasurementValueSpec<PhaseTypeMeasurementValue> measurementValueSpec) {
  ...
  static Stream<Arguments> getTestConvertArgumentsAssoc() {
    final PhaseTypeMeasurementValue ptmValue1 =
        PhaseTypeMeasurementValue.fromFeaturePrediction(PhaseType.S, Optional.of(0.8));
    final PhaseTypeMeasurementValue ptmValue2 =
        PhaseTypeMeasurementValue.fromFeaturePrediction(PhaseType.P, Optional.of(0.5));
    final PhaseTypeMeasurementValue ptmValue3 =
        PhaseTypeMeasurementValue.fromFeatureMeasurement(
            PhaseType.Tx, Optional.empty(), Instant.EPOCH);
    final PhaseTypeMeasurementValue ptmValue4 =
        PhaseTypeMeasurementValue.fromFeaturePrediction(PhaseType.P, Optional.empty());
    ...
    MeasurementValueSpec<PhaseTypeMeasurementValue> measurementValueSpec2 =
        MeasurementValueSpec.<PhaseTypeMeasurementValue>builder()
            ...
            .setFeatureMeasurementType(FeatureMeasurementTypes.PHASE)
            .build();
    MeasurementValueSpec<PhaseTypeMeasurementValue> measurementValueSpec3 =
        MeasurementValueSpec.<PhaseTypeMeasurementValue>builder()
            .setArrivalDao(arrivalDao2)
            .setFeatureMeasurementType(FeatureMeasurementTypes.PHASE)
            .build();
    MeasurementValueSpec<PhaseTypeMeasurementValue> measurementValueSpec4 =
        MeasurementValueSpec.<PhaseTypeMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_1)
  ...
  void testIllegalState(MeasurementValueSpec<PhaseTypeMeasurementValue> measurementValueSpec) {
    ...
    assertThrows(IllegalStateException.class, () -> converter.convert(measurementValueSpec));
  }
  ...
  static Stream<Arguments> getTestIllegalStateArguments() {
    ...
    return Stream.of(arguments(measurementValueSpec2));
  }
}

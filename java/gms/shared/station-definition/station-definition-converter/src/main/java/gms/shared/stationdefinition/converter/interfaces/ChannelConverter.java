...
public interface ChannelConverter {
  ...
  /**
   * Converts the SiteChan, Sensor, and Instrument objects, combined with a station name, to a
   * {@link Channel}
   *
  ...
  /**
   * Converts the provided {@link SiteDao} and {@link SiteChanDao} into a version reference (name
   * and effective time)
   *
  ...
  /**
   * Converts the provided {@link SiteDao} and {@link SiteChanDao} into an entity reference (name
   * only) {@link Channel}. {@link Channel}
   *
   * @param siteDao The site dao providing the station portion of the name
   * @param siteChanDao The site chan for defining the remaining parts of the name

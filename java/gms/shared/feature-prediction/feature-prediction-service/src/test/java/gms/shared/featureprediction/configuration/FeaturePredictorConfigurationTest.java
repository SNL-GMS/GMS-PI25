...
class FeaturePredictorConfigurationTest {
  ...
  void testGetCurrentFeaturePredictorDefinition() {
    ...
    var expectedDefinition =
        FeaturePredictorDefinition.from(
            Map.of(
                FeaturePredictionType.ARRIVAL_TIME_PREDICTION_TYPE,
                "BicubicSplineFeaturePredictor"));

    var actualDefinition =
        featurePredictorConfiguration.currentFeaturePredictorDefinition(
    ...
    Assertions.assertEquals(
        "BicubicSplineFeaturePredictor",
        actualDefinition.getPluginNameByType(FeaturePredictionType.ARRIVAL_TIME_PREDICTION_TYPE));
  }
    ...
    var configurationRoot =
        Objects.requireNonNull(
                Thread.currentThread()
                    ...
                    .getResource("pathological-configuration-base/not-a-map"))
            .getPath();
  ...
  void testGetCurrentFeaturePredictorDefinitionThrowsErrorForBadFeatureMeasurement() {
    ...
    var configurationRoot =
        Objects.requireNonNull(
                Thread.currentThread()
                    .getContextClassLoader()
                    .getResource("pathological-configuration-base/no-matching-feature-measurement"))
            .getPath();

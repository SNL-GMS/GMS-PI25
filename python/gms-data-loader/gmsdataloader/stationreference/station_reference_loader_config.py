...
class StationReferenceLoaderConfig:
    ...
    def __init__(self, base_url: str, config_path: str | None = None) -> None:
        ...
        routes = self._loader_config["routes"]
        self.sta_ref_obj_urls = StationReferenceObjectUrls(
            base_url=base_url,
            ref_networks_route=routes["ref_networks"],
            ref_stations_route=routes["ref_stations"],
            ref_sites_route=routes["ref_sites"],
            ref_chans_route=routes["ref_chans"],
            ref_sensors_route=routes["ref_sensors"]
        )
        self.sta_ref_memb_urls = StationReferenceMembershipUrls(
            base_url=base_url,
            ref_network_memb_route=routes["ref_network_memberships"],
            ref_station_memb_route=routes["ref_station_memberships"],
            ref_site_memb_route=routes["ref_site_memberships"]
        )
...
class StationReferenceObjectUrls:
    ...
    def __init__(
        self,
        base_url: str,
        ref_networks_route: str,
        ref_stations_route: str,
        ref_sites_route: str,
        ref_chans_route: str,
        ref_sensors_route: str
    ) -> None:
...
class StationReferenceMembershipUrls:
    ...
    def __init__(
        self,
        base_url: str,
        ref_network_memb_route: str,
        ref_station_memb_route: str,
        ref_site_memb_route: str
    ) -> None:

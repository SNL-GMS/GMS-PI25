...
class StationProcessingLoaderConfig:
    ...
    def __init__(self, base_url: str, config_path: str | None = None) -> None:
        ...
        self.station_groups_store_url = (
            base_url + self._loader_config['routes']['station_groups_store']
        )
        self.station_groups_update_url = (
            base_url + self._loader_config['routes']['station_groups_update']
        )

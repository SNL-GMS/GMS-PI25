...
public abstract class DelegatingRequestHandler<T, U> implements RequestHandler<U> {
  ...
  public Response<U> handle(Request request, ObjectMapper objectMapper) {
    ...
    try {
      ...
      return Response.clientError(logAndReturnErrorMsg("handlerOperation rejected input", e));
    } catch (Exception e) {
      return Response.serverError(logAndReturnErrorMsg("invoking handlerOperation failed", e));
    }
  }

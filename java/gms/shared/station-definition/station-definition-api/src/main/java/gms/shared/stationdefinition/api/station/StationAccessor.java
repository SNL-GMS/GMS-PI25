...
/** Accessor interface for retrieving {@link Station}s */
public interface StationAccessor extends StationRepository {
  /**
   ...
   */
  List<Station> findStationsByNameAndTime(
   ...
   */
  List<Instant> determineStationChangeTimes(Station station, Instant startTime, Instant endTime);
}

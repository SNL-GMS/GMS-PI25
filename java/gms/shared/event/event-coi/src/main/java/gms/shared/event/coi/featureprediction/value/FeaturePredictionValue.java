...
/**
 * Represents a feature prediction value, which is a combination of the predicted value itself, the
 * components (such as corrections) that went into calculating the value, and the derivatives around
 * the point where the value is being calculated.
 *
...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(
      value = NumericFeaturePredictionValue.class,
      name = "RECEIVER_TO_SOURCE_AZIMUTH"),
  @JsonSubTypes.Type(
      value = NumericFeaturePredictionValue.class,
      name = "SOURCE_TO_RECEIVER_AZIMUTH"),
  @JsonSubTypes.Type(
      value = NumericFeaturePredictionValue.class,
...
public abstract class FeaturePredictionValue<T, U, V> {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(featureMeasurementType, that.featureMeasurementType)
        && Objects.equals(predictedValue, that.predictedValue)
        && Objects.equals(derivativeMap, that.derivativeMap)
        && Objects.equals(featurePredictionComponentSet, that.featurePredictionComponentSet);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        featureMeasurementType, predictedValue, derivativeMap, featurePredictionComponentSet);
  }
}

...
export type GenericKeyAction = AnalystWorkspaceTypes.AnalystKeyAction | DataAcquisitionKeyAction;
...
const getKeyAction = (
  ...
  return (
    AnalystWorkspaceTypes.AnalystKeyActions.get(keyStr) ?? DataAcquisitionKeyActions.get(keyStr)
  );
};

...
public abstract class ServiceRequest {
   ...
   * @throws IllegalArgumentException if timeout is negative
   */
  public static Builder builder(URL url, Object body, Duration timeout, Type responseType) {
  ...
  public abstract static class Builder {
    ...
    public ServiceRequest build() {
      ...
      Validate.isTrue(!req.getTimeout().isNegative(), "Timeout cannot be negative");
      return req;
    }
  }
}

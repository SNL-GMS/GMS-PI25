...
class NumericMeasurementValueConverterTest
  ...
  private static final NumericMeasurementValue VALUE_2 =
      NumericMeasurementValue.from(
          Optional.empty(), DoubleValue.from(32.1, Optional.empty(), Units.SECONDS));
  private static final NumericMeasurementValue VALUE_3 =
      NumericMeasurementValue.from(
  ...
  void testConvert(
      NumericMeasurementValue expectedValue, MeasurementValueSpec<NumericMeasurementValue> spec) {
  ...
  static Stream<Arguments> getConvertValidationArguments() {
    MeasurementValueSpec<NumericMeasurementValue> spec1 =
        MeasurementValueSpec.<NumericMeasurementValue>builder()
            ...
            .build();
    MeasurementValueSpec<NumericMeasurementValue> spec2 =
        MeasurementValueSpec.<NumericMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_1)
            .setFeatureMeasurementType(FeatureMeasurementTypes.EMERGENCE_ANGLE)
  ...
  static Stream<Arguments> getTestConvertArguments() {
    ...
    MeasurementValueSpec<NumericMeasurementValue> measurementValueSpec2 =
        MeasurementValueSpec.<NumericMeasurementValue>builder()
            ...
            .build();
    MeasurementValueSpec<NumericMeasurementValue> measurementValueSpec3 =
        MeasurementValueSpec.<NumericMeasurementValue>builder()
            .setArrivalDao(ARRIVAL_2)

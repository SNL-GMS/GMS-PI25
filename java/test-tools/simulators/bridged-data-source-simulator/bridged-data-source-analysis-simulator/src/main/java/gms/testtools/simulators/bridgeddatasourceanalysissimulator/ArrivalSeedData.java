...
public class ArrivalSeedData {
  ...
  private ArrivalSeedData(
      Collection<ArrivalDao> arrivalsDaos,
  ...
  public static ArrivalSeedData create(
      Collection<ArrivalDao> arrivalDaos,
      Collection<AmplitudeDao> amplitudeDaos,
      Collection<WfTagDao> wfTagDaos,
      Instant seedDataStartTime,
      Instant seedDataEndTime) {

    return new ArrivalSeedData(
        arrivalDaos, amplitudeDaos, wfTagDaos, seedDataStartTime, seedDataEndTime);
  }

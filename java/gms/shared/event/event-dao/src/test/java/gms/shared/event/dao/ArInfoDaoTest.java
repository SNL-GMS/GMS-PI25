...
class ArInfoDaoTest {
    ...
    happyBuilder =
        new ArInfoDao.Builder()
            .withOriginIdArrivalIdKey(
                new OriginIdArrivalIdKey.Builder().withOriginId(11111).withArrivalId(22222).build())
            .withTimeErrorCode(1)
  ...
  void testBuilderSadOriginId() {
    ...
    keyBuilder = new OriginIdArrivalIdKey.Builder().withOriginId(0);
    assertThrows(IllegalArgumentException.class, () -> keyBuilder.build());
  }

  @Test
  void testBuilderSadArrivalId() {

    keyBuilder = new OriginIdArrivalIdKey.Builder().withArrivalId(0);
    assertThrows(IllegalArgumentException.class, () -> keyBuilder.build());
  }

  @Test
  void testBuilderSadTimeErrorCode() {
    happyBuilder.withTimeErrorCode(-1);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withTimeErrorCode(21);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadAzimuthErrorCode() {
    ...
    happyBuilder.withAzimuthErrorCode(-1);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withAzimuthErrorCode(20);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }

  @Test
  void testBuilderSadSlownessErrorCode() {
    happyBuilder.withSlownessErrorCode(-1);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withSlownessErrorCode(20);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadCorrectionCode() {
    ...
    happyBuilder.withCorrectionCode(-1);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withCorrectionCode(20);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadVelocityModel() {
    ...
    happyBuilder.withVelocityModel("VelocityModelNameTooLong");
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadTotalTravelTime() {
    ...
    happyBuilder.withTotalTravelTime(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withTotalTravelTime(86401);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadBaseModelTravelTime() {
    ...
    happyBuilder.withBaseModelTravelTime(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());

    happyBuilder.withBaseModelTravelTime(86401);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadTravelTimeEllipticityCorrection() {
    ...
    happyBuilder.withTravelTimeEllipticityCorrection(-51);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadTravelTimeElevationCorrection() {
    ...
    happyBuilder.withTravelTimeElevationCorrection(-51);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadTravelTimeStaticCorrection() {
    ...
    happyBuilder.withTravelTimeStaticCorrection(-51);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadTravelTimeSourceSpecificCorrection() {
    ...
    happyBuilder.withTravelTimeSourceSpecificCorrection(-51);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadTravelTimeModelError() {
    ...
    happyBuilder.withTravelTimeModelError(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadTravelTimeMeasurementError() {
    ...
    happyBuilder.withTravelTimeMeasurementError(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadTravelTimeModelPlusMeasurementError() {
    ...
    happyBuilder.withTravelTimeModelPlusMeasurementError(0);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadAzimuthSourceSpecificCorrection() {
    ...
    happyBuilder.withAzimuthSourceSpecificCorrection(-181);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadSlownessModelError() {
    ...
    happyBuilder.withSlownessModelError(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadSlownessMeasurementError() {
    ...
    happyBuilder.withSlownessMeasurementError(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadSlownessModelPlusMeasurementError() {
    ...
    happyBuilder.withSlownessModelPlusMeasurementError(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  }
  ...
  void testBuilderSadTravelTimeImport() {
    ...
    happyBuilder.withTravelTimeImport(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadAzimuthImport() {
    ...
    happyBuilder.withAzimuthImport(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadSlownessImport() {
    ...
    happyBuilder.withSlownessImport(-2);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadwithSlownessVectorResidual() {
    ...
    happyBuilder.withSlownessVectorResidual(-1001);
    assertThrows(IllegalArgumentException.class, () -> happyBuilder.build());
  ...
  void testBuilderSadLoadDate() {
    ...
    happyBuilder.withLoadDate(null);
    assertThrows(NullPointerException.class, () -> happyBuilder.build());
  }
}

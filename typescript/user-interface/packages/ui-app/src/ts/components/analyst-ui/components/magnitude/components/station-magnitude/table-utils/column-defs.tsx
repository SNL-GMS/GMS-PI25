...
const applyHighlightToCell = (params: any): any => {
  ...
  const evenMagType = magTypeHasError ? gmsColors.gmsTableWarningEvenRow : highlightColorEven;
  const evenValue = isSelected ? isSelectedMagTypeHasError : evenMagType;
  const oddMagType = magTypeHasError ? gmsColors.gmsTableWarningOddRow : highlightColorOdd;

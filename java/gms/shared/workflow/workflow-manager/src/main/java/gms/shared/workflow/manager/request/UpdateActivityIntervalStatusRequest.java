...
public abstract class UpdateActivityIntervalStatusRequest implements UserRequest {
   ...
   *
   * @return The {@link IntervalId} of the {@link gms.shared.workflow.coi.ActivityInterval} to
   *     update
   */
  public abstract IntervalId getActivityIntervalId();

  /**
   * Gets the {@link IntervalId} of the {@link gms.shared.workflow.coi.StageInterval} containing the
   * {@link gms.shared.workflow.coi.ActivityInterval} to update
   *
   * @return The {@link IntervalId} of the {@link gms.shared.workflow.coi.StageInterval} containing
   *     the {@link gms.shared.workflow.coi.ActivityInterval} to update
   */
  public abstract IntervalId getStageIntervalId();

  /**
   * Gets the {@link IntervalStatus} to apply to the specified {@link
   * gms.shared.workflow.coi.ActivityInterval}
   *

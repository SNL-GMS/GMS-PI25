...
class FileStoreTest {
  ...
  void testFindByFileDescriptorObjectMapper(
  ...
  private static Stream<Arguments> findByFileDescriptor_objectMapper_TestSource()
  ...
  void testFindByKeyPrefixObjectMapper(
      FileDescriptor fileDescriptor,

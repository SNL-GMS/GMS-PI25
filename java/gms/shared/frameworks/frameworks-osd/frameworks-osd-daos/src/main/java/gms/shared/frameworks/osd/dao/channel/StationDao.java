...
public class StationDao implements Serializable {
  ...
  private StationDao(String name, StationType type, String description, LocationDao location) {
    this.name = name;
    this.type = type;
  ...
  public static StationDao from(Station station) {
    return new StationDao(
        ...
        new LocationDao(station.getLocation()));
  }
  ...
  public void setChannelGroups(List<ChannelGroupDao> channelGroups) {

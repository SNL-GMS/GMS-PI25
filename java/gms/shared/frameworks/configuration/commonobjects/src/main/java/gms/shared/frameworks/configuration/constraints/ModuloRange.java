...
public abstract class ModuloRange<T> {
  ...
  @JsonIgnore private final long modulo;
  ...
  public boolean contains(T val, boolean includeMin, boolean includeMax) {
    ...
    boolean isGoodLength = (0 < testLength) && (testLength < myLength);
    boolean meetsMin = val.equals(getMin()) && includeMin;
    boolean meetsMax = val.equals(getMax()) && includeMax;

    return isGoodLength || meetsMin || meetsMax;
  }
}

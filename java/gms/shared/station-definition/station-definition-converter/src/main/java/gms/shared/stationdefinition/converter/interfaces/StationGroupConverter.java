...
public interface StationGroupConverter {
  ...
  /**
   * Converts networkKey map, networkDescription, and List of Stations into COI {@link StationGroup}
   * objects
   *
   ...
   */
  StationGroup convert(
      Pair<String, Instant> networkKey, String networkDescription, List<Station> stationList);

  /**
   * Converts {@link NetworkDao} and list of {@link SiteDao}s to a populated {@link StationGroup}
   * with list of {@link Station} version references
   *

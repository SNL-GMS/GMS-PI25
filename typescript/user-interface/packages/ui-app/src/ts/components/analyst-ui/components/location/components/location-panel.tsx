...
export class LocationPanel extends React.Component<LocationPanelProps, LocationPanelState> {
          ...
          <HorizontalDivider
            ...
            bottom={
              <LocationSignalDetections
                ...
                deleteDetections={this.props.deleteDetections}
                ...
                showSDContextMenu={event => {
                  this.signalDetectionContextMenusCb.signalDetectionContextMenuCb(
                    event,
                    this.getSignalDetectionContextMenuContentProps()
                  );
                }}
   ...
   */
  private readonly getSignalDetectionContextMenuContentProps = (): SignalDetectionContextMenuContentProps => {
    return {
      keyPrefix: 'location-sd',

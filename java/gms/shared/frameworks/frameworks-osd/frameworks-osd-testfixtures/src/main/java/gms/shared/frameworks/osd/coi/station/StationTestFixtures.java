...
public class StationTestFixtures {
  ...
  private static final Station txar =
      Station.from(
          "TXAR",
          StationType.SEISMIC_ARRAY,
          "TXAR_Array,_Texas",
          Map.of(
              ChannelTestFixtures.txarTx01Shz().getName(),
  ...
  public static StationGroup getStationGroup() {
    return StationGroup.from("Test Station Group", "Test StationGroup", List.of(asar, pdar, txar));
  }

...
/** Accessor interface for retrieving {@link StationGroup}s */
public interface StationGroupAccessor extends StationGroupRepository {
   ...
   */
  List<StationGroup> findStationGroupsByNameAndTime(
      List<String> stationGroupNames, Instant effectiveTime, FacetingDefinition facetingDefinition);
}

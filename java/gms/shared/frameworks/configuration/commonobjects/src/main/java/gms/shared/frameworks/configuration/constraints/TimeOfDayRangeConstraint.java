 ...
 * maximum value).
 *
 * <p>When the maximum time of day value occurs prior to the minimum time of day value,
...
public abstract class TimeOfDayRangeConstraint implements Constraint<TimeOfDayRange, LocalTime> {
  ...
  public static TimeOfDayRangeConstraint from(
    ...
    return new AutoValue_TimeOfDayRangeConstraint(
        ConstraintType.TIME_OF_DAY_RANGE, criterion, operator, priority, value);
  }

...
public abstract class WorkspaceLayout {
  ...
  @JsonCreator
  public static WorkspaceLayout from(
      @JsonProperty("name") String name,
      @JsonProperty("supportedUserInterfaceModes")
    ...
    Validate.notEmpty(
        ...
        "WorkspaceLayout requires a non-empty list of supported user interface modes");
    Validate.notEmpty(
        layoutConfiguration, "WorkspaceLayout requires a non-empty layout configuration");

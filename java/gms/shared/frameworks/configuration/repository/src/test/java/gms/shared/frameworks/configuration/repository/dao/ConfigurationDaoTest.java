...
class ConfigurationDaoTest {
  ...
  public void init() throws IOException {
    ...
    Configuration configuration = Configuration.from("test-config", new ArrayList<>());
  ...
  void testEquals() {
    ...
    assertEquals(
        this.configurationDao2, this.configurationDao1, "equals not correct for ConfigurationDao");
  }
  ...
  void testHashCode() {
    ...
    assertTrue(
        configurationDaoSet.contains(this.configurationDao2),
        "hash code not correct for ConfigurationDao");
  }
}

...
public abstract class ReferenceCalibration {
  ...
  public static ReferenceCalibration from(
    ...
    Objects.requireNonNull(
        calibrationInterval, "Cannot create ReferenceCalibration with null calibrationInterval");
    Objects.requireNonNull(calibration, "Cannot create ReferenceCalibration with null calibration");

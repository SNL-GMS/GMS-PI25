...
public final class IntervalUtility {
  ...
  private static final Map<Pair<String, String>, String> legacyClassAndNameToStageName =
      Map.of(
  ...
  private static final Map<String, Pair<String, String>> stageNameToLegacyClassAndName =
      legacyClassAndNameToStageName.entrySet().stream()

...
> {
  ...
  private readonly getColumnCellRender = (
    ...
    return !disableStaticMarkupForCellRendererFramework && columnDefinition.cellRenderer
      ? params =>
  ...
  private readonly getUpdatedDefinition = (
    ...
    const columnDefRenderer =
      ...
      this.getColumnCellRender(disableStaticMarkupForCellRendererFramework, columnDefinition);

...
class MediumVelocityLoaderTest(unittest.TestCase):
    ...
    def test_get_minio_prefix_map(self):
        with patch(
            'gmsdataloader.mediumvelocity.MediumVelocityMinioConfig'
        ) as mock_config:
            loader = MediumVelocityLoader(
                f'{WORKING_DIR}/resources/mediumvelocity',
                mock_config
            )
            ...
            self.assertTrue(
                f'{WORKING_DIR}/resources/mediumvelocity/ak135.json' in
                prefix_map['mediumvelocity/ak135']
            )
    ...
    def test_load(self):
        with patch('minio.Minio') as client_mocker:
            ...
            config = MediumVelocityMinioConfig(
            ...
            mock_client.fput_object.assert_has_calls([
                call(
                    'testbucket',
                    'mediumvelocity/ak135',
                    f'{WORKING_DIR}/resources/mediumvelocity/ak135.json'
                )
            ])

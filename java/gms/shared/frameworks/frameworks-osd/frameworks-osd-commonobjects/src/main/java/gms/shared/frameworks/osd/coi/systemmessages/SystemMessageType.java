...
public enum SystemMessageType {
  ...
  STATION_NEEDS_ATTENTION(
      "Station %s needs attention",
      SystemMessageSeverity.CRITICAL,
  ...
  STATION_SOH_STATUS_CHANGED(
      "Station %s SOH status changed from %s to %s",
  ...
  STATION_GROUP_CAPABILITY_STATUS_CHANGED(
      "Station Group %s capability status changed from %s to %s",
      SystemMessageSeverity.WARNING,
      SystemMessageCategory.SOH,
      SystemMessageSubCategory.CAPABILITY,
  ...
  CHANNEL_MONITOR_TYPE_QUIETED(
      "Station %s Channel %s %s quieted for %s by user %s"
  ...
  CHANNEL_MONITOR_TYPE_QUIET_PERIOD_CANCELED(
      "Station %s Channel %s %s quiet period canceled by user %s",
      SystemMessageSeverity.INFO,
      SystemMessageCategory.SOH,
      SystemMessageSubCategory.USER,
      Set.of(STATION, CHANNEL, MONITOR_TYPE)),
  ...
  CHANNEL_MONITOR_TYPE_QUIET_PERIOD_EXPIRED(
      "Station %s Channel %s %s quiet period expired",
      SystemMessageSeverity.INFO,
      SystemMessageCategory.SOH,
      SystemMessageSubCategory.STATION,
      Set.of(STATION, CHANNEL, MONITOR_TYPE));

...
public class ConstraintDaoConverter implements EntityConverter<ConstraintDao, Constraint> {
  ...
  public ConstraintDaoConverter(ConfigurationOptionDao configurationOptionDao) {
    ...
    this.constraintDaoSupplierMap.put(
        ConstraintType.NUMERIC_SCALAR, NumericScalarConstraintDao::new);
    ...
    this.constraintDaoSupplierMap.put(
        ConstraintType.TIME_OF_DAY_RANGE, TimeOfDayRangeConstraintDao::new);
    this.constraintDaoSupplierMap.put(
        ConstraintType.TIME_OF_YEAR_RANGE, TimeOfYearRangeConstraintDao::new);

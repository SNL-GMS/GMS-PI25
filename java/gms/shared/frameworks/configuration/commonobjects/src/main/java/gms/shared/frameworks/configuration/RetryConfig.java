...
/**
 * Configuration class for applying basic retry configuration to policies such as {@link
 * RetryPolicy} and Project Reactor's Retry
 */
@AutoValue
public abstract class RetryConfig {
  ...
  public static RetryConfig create(
    ...
    checkArgument(
        ...
        "Max attempts must be greater than zero, or exactly -1 for no limit");
   ...
   * @return A {@link RetryPolicy<T>} containing basic configuration provided by this {@link
   *     RetryConfig}
   */

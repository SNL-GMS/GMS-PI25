...
function getValuesFromParamsMagnitudeType(params) {
  const paramZeroValue = params.value === 0 ? params.value : '-';
  return params.value ? params.value : paramZeroValue;
}
...
function formatNumberOrDash(params) {
  const paramsZeroValue = params.value === 0 ? params.value : '-';
  return params.value ? params.value : paramsZeroValue;
}
  ...
  return {
    ...
    children: [
      ...
      },
      {
        ...
        hide: !displayedMagnitudeTypes[magnitudeType],
        ...magnitudeColumnRepeatedArguments,
        valueFormatter: params => getValuesFromParamsMagnitudeType(params)
      },
      {

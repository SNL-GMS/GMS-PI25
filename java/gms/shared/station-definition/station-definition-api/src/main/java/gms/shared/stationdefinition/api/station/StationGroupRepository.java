...
/**
 * Interface for providing {@link StationGroup}s; storing {@link StationGroup}s is not allowed by
 * default
 */
public interface StationGroupRepository {

  /**
   * Finds {@link StationGroup}s having one of the provided names that were active at the effective
   * time
   *
   ...
   * @return A list of {@link StationGroup}s with the provided names and active between the provided
   *     times
   */

...
public abstract class WildcardConstraint implements Constraint<String, Object> {
   ...
   */
  @JsonCreator
  public static WildcardConstraint from(@JsonProperty("criterion") String criterion) {

    return new AutoValue_WildcardConstraint(
        ConstraintType.WILDCARD, criterion, Operator.from(Type.EQ, false), 0, "*");
  }

...
public class SystemMessageDao {
  ...
  @Enumerated(EnumType.STRING)
  @Column(
      name = "system_message_severity",
      nullable = false,
      columnDefinition = "public.system_message_severity_enum")
  private SystemMessageSeverity systemMessageSeverity;

  @Type(PostgreSQLEnumType.class)
  @Enumerated(EnumType.STRING)
  @Column(
      name = "system_message_category",
      nullable = false,
      columnDefinition = "public.system_message_category_enum")
  private SystemMessageCategory systemMessageCategory;

  @Type(PostgreSQLEnumType.class)
  @Enumerated(EnumType.STRING)
  @Column(
      name = "system_message_sub_category",
      nullable = false,
      columnDefinition = "public.system_message_sub_category_enum")

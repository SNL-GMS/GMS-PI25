...
public abstract class SignalDetectionHypothesisAssocIdComponents {
  ...
  public static SignalDetectionHypothesisAssocIdComponents create(
      String legacyDatabaseAccountId, long arid, long orid) {
    return new AutoValue_SignalDetectionHypothesisAssocIdComponents(

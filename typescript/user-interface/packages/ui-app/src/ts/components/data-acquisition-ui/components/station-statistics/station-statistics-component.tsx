...
const mapStateToProps = (state: AppState) => ({
  ...
  columnsSelected: state.app.dataAcquisition.stationStatisticsColumns,
  statusesToDisplay:
...
const mapDispatchToProps = {
  ...
  setStationStatisticsColumns: (columns: Record<string, boolean>) => dispatch => {
    dispatch(dataAcquisitionActions.setStationStatisticsColumns(columns));
  },
  ...
  resetDrillDownsFiltersToDefault: () => dispatch => {
    dispatch(dataAcquisitionActions.resetDrillDownsFiltersToDefault());
  }
};
...
export class StationStatisticsComponent extends React.Component<StationStatisticsProps> {
  ...
  private readonly resetDrillDownFiltersAndSelectStation = (ids: string[]) => {
    this.props.setSelectedStationIds(ids);
    this.props.resetDrillDownsFiltersToDefault();
  };
  ...
  public render(): JSX.Element {
    this.memoizedStationStatisticsContextData = memoizeOne(() => {
      return {
        ...
        setSelectedStationIds: this.resetDrillDownFiltersAndSelectStation
      };
    }, isEqual);
    return (
      <StationStatisticsContext.Provider value={this.memoizedStationStatisticsContextData()}>
        ...
        >
          <StationStatisticsPanel
            ...
            columnsSelected={this.props.columnsSelected}
            setGroupSelected={this.props.setStationStatisticsGroup}
            setColumnsSelected={this.props.setStationStatisticsColumns}
          />
        </BaseDisplay>

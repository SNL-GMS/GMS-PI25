...
class ReferenceSiteTest {
  ...
  final UUID versionId =
      UUID.nameUUIDFromBytes(
          (StationReferenceTestFixtures.SITE_NAME
                  + StationReferenceTestFixtures.LATITUDE
                  + StationReferenceTestFixtures.LONGITUDE
                  + StationReferenceTestFixtures.ELEVATION
                  + StationReferenceTestFixtures.ACTUAL_TIME)

...
{{- define "gms.common.pod.nodeAffinity" }}
  {{- if or (not .appValues.nodeAffinity.key) (not .appValues.nodeAffinity.operator) (not .appValues.nodeAffinity.type) }}
    {{- printf "ERROR: %s.nodeAffinity must contain .key, .operator, and .type: %s" $.appName .appValues.nodeAffinity | fail }}
  {{- end }}
...
nodeAffinity:
  preferredDuringSchedulingIgnoredDuringExecution:
    ...
    {{- if .appValues.nodeAffinity.values }}
            values:

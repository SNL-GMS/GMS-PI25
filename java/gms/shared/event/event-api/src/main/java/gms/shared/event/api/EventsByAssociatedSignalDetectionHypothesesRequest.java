...
public abstract class EventsByAssociatedSignalDetectionHypothesesRequest {
   ...
   *
   * @param signalDetectionHypotheses A collection of {@link SignalDetectionHypothesis} objects for

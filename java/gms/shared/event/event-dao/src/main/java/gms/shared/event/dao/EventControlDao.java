...
public class EventControlDao {
  ...
  private EventControlDao(Builder builder) {
    ...
    this.sourceDependentMagnitudeCorrectionRegion =
        builder.sourceDependentMagnitudeCorrectionRegion;
  ...
  public void setUseAllStationsInLocation(boolean useAllStationsInLocation) {
  ...
  public void setUserDefinedDistanceVarianceWeighting(Double userDefinedDistanceVarianceWeighting) {
  ...
  public static class Builder {
    ...
    public static EventControlDao.Builder initializeFromInstance(EventControlDao dao) {
      return new EventControlDao.Builder()
          ...
          .withSourceDependentMagnitudeCorrectionRegion(
              dao.sourceDependentMagnitudeCorrectionRegion)
  ...
  public boolean equals(Object o) {
    ...
    return constrainOriginTime == that.constrainOriginTime
        ...
        && Double.compare(that.locationLargeResidualMultiplier, locationLargeResidualMultiplier)
            == 0
        ...
        && Double.compare(
                that.userDefinedDistanceVarianceWeighting, userDefinedDistanceVarianceWeighting)
            == 0
        && ignoreLargeResidualsInMagnitude == that.ignoreLargeResidualsInMagnitude
        && Double.compare(that.magnitudeLargeResidualMultiplier, magnitudeLargeResidualMultiplier)
            == 0
        ...
        && Double.compare(that.ellipseSemiaxisConversionFactor, ellipseSemiaxisConversionFactor)
            == 0
        && Double.compare(that.ellipseDepthTimeConversionFactor, ellipseDepthTimeConversionFactor)
            == 0
        && Objects.equals(eventIdOriginIdKey, that.eventIdOriginIdKey)
        && Objects.equals(preferredLocation, that.preferredLocation)
        && Objects.equals(
            sourceDependentLocationCorrectionRegion, that.sourceDependentLocationCorrectionRegion)
        && Objects.equals(
            sourceDependentMagnitudeCorrectionRegion, that.sourceDependentMagnitudeCorrectionRegion)
        && Objects.equals(magnitudeModel, that.magnitudeModel)
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        constrainLatLon,
        constrainDepth,
        sourceDependentCorrectionCode,
        sourceDependentLocationCorrectionRegion,
        ignoreLargeResidualsInLocation,
        locationLargeResidualMultiplier,
        useStationSubsetInLocation,
        useAllStationsInLocation,
        useDistanceVarianceWeighting,
        userDefinedDistanceVarianceWeighting,
        sourceDependentMagnitudeCorrectionRegion,
        ignoreLargeResidualsInMagnitude,
        magnitudeLargeResidualMultiplier,
        useStationSubsetInMagnitude,
        useAllStationsInMagnitude,
        mbMinimumDistance,
        mbMaximumDistance,
        magnitudeModel,
        ellipseSemiaxisConversionFactor,
        ellipseDepthTimeConversionFactor,
        loadDate);
  }

...
class CleanStructuredArgumentTest {
  ...
  private static Stream<Arguments> scrubbedStringTest() {
    return Stream.of(
        arguments(
            "INFO:\t2022-01-01T00:00:00Z\tLog entry successful.",
            "INFO:\t2022-01-01T00:00:00Z\tLog entry successful."),
        arguments("Bad#@!", "Bad!"),
        ...
        arguments(
            "^-- 2022-01-01 INFO: {This is an entry[This too]}",
            "^-- 2022-01-01 INFO: {This is an entry[This too]}"),
        arguments(
            "LogLevel: INFO \t\t####My comment here!\n[And another one.]",
            "LogLevel: INFO \t\tMy comment here![And another one.]"));
  }
}

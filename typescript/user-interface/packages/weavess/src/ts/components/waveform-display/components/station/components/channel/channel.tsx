...
export class Channel extends React.PureComponent<ChannelProps, ChannelState> {
  ...
  public render(): JSX.Element {
    const isChannelMaskTarget =
      this.props.isStationMaskTarget &&
      this.props.selections.channels?.includes(this.props.channel.id);
    ...
    return (
      ...
      <div
        className={classNames({
          ...
          'split-channel': !!this.props.channel.splitChannelTime
        })}
      ...
      >
        <Overlay
          ...
          usePortal={false}
          onClose={this.props.closeSignalDetectionOverlayCallback}
        />
  ...
  private readonly internalRenderScene = (
    ...
    if (waveformRect.bottom < canvasRect.top || waveformRect.top > canvasRect.bottom) {
